...
func TestRecordFieldResolverUpdateQuery(t *testing.T) {
	...
	scenarios := []struct {
	...
	}{
		{
			...
			*/
			// PostgreSQL:
			`SELECT "demo4".* FROM "demo4" WHERE ([[demo4.title]] = TRUE OR [[demo4.title]] IS DISTINCT FROM {:TEST} OR [[demo4.title]] LIKE {:TEST} ESCAPE '\' OR [[demo4.title]] NOT LIKE {:TEST} ESCAPE '\' OR [[demo4.title]] > 1 OR [[demo4.title]] >= 2 OR [[demo4.title]] < 3 OR [[demo4.title]] <= 4)`,
		},
		{
		...
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo4".* FROM "demo4" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[demo4.self_rel_many]] IS JSON OR json_valid([[demo4.self_rel_many]]::text)) AND jsonb_typeof([[demo4.self_rel_many]]::jsonb) = 'array' THEN [[demo4.self_rel_many]]::jsonb ELSE jsonb_build_array([[demo4.self_rel_many]]) END) "demo4_self_rel_many_je" ON 1=1 LEFT JOIN "demo4" "demo4_self_rel_many" ON [[demo4_self_rel_many.id]] = [[demo4_self_rel_many_je.value]] LEFT JOIN "demo4" "demo4_self_rel_one" ON [[demo4_self_rel_one.id]] = [[demo4.self_rel_one]] WHERE ((([[demo4_self_rel_many.title]] = {:TEST}) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo4_self_rel_many.title]] as [[multiMatchValue]] FROM "demo4" "__mm_demo4" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo4.self_rel_many]] IS JSON OR json_valid([[__mm_demo4.self_rel_many]]::text)) AND jsonb_typeof([[__mm_demo4.self_rel_many]]::jsonb) = 'array' THEN [[__mm_demo4.self_rel_many]]::jsonb ELSE jsonb_build_array([[__mm_demo4.self_rel_many]]) END) "__mm_demo4_self_rel_many_je" ON 1=1 LEFT JOIN "demo4" "__mm_demo4_self_rel_many" ON [[__mm_demo4_self_rel_many.id]] = [[__mm_demo4_self_rel_many_je.value]] WHERE "__mm_demo4"."id" = "demo4"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] = {:TEST})))) OR JSON_QUERY_OR_NULL([[demo4_self_rel_one.json_object]], '$.a')::jsonb > TRUE)`,
		},
		{
		...
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo1".* FROM "demo1" LEFT JOIN "users" "__data_users_rel_many" ON [[__data_users_rel_many.id]] IN ({:p0}, {:p1}) LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[demo1.rel_many]] IS JSON OR json_valid([[demo1.rel_many]]::text)) AND jsonb_typeof([[demo1.rel_many]]::jsonb) = 'array' THEN [[demo1.rel_many]]::jsonb ELSE jsonb_build_array([[demo1.rel_many]]) END) "demo1_rel_many_je" ON 1=1 LEFT JOIN "users" "demo1_rel_many" ON [[demo1_rel_many.id]] = [[demo1_rel_many_je.value]] WHERE (LOWER({:infoLowerrel_oneTEST}) > TRUE OR LOWER({:infoLowerrel_manyTEST}) > TRUE OR ((LOWER([[__data_users_rel_many.email]]) > TRUE) AND (NOT EXISTS (SELECT 1 FROM (SELECT LOWER([[__data_mm_users_rel_many.email]]) as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN "users" "__data_mm_users_rel_many" ON [[__data_mm_users_rel_many.id]] IN ({:p4}, {:p5}) WHERE "__mm_demo1"."id" = "demo1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > TRUE)))) OR LOWER([[demo1.text]]) > TRUE OR LOWER([[demo1.bool]]) > TRUE OR LOWER([[demo1.url]]) > TRUE OR LOWER([[demo1.select_one]]) > TRUE OR LOWER([[demo1.select_many]]) > TRUE OR LOWER([[demo1.file_one]]) > TRUE OR LOWER([[demo1.file_many]]) > TRUE OR LOWER([[demo1.number]]) > TRUE OR LOWER([[demo1.email]]) > TRUE OR LOWER([[demo1.datetime]]) > TRUE OR LOWER(JSON_QUERY_OR_NULL([[demo1.json]], '$')::jsonb) > TRUE OR LOWER([[demo1.rel_one]]) > TRUE OR LOWER([[demo1.rel_many]]) > TRUE OR ((LOWER([[demo1_rel_many.name]]) > TRUE) AND (NOT EXISTS (SELECT 1 FROM (SELECT LOWER([[__mm_demo1_rel_many.name]]) as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo1.rel_many]] IS JSON OR json_valid([[__mm_demo1.rel_many]]::text)) AND jsonb_typeof([[__mm_demo1.rel_many]]::jsonb) = 'array' THEN [[__mm_demo1.rel_many]]::jsonb ELSE jsonb_build_array([[__mm_demo1.rel_many]]) END) "__mm_demo1_rel_many_je" ON 1=1 LEFT JOIN "users" "__mm_demo1_rel_many" ON [[__mm_demo1_rel_many.id]] = [[__mm_demo1_rel_many_je.value]] WHERE "__mm_demo1"."id" = "demo1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > TRUE)))) OR LOWER([[demo1.created]]) > TRUE)`,
		},
		{
			"isset modifier",
			"demo1",
		...
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo1".* FROM "demo1" LEFT JOIN jsonb_array_elements({:dataEachTEST}::jsonb) "__dataEach_select_one_je" ON 1=1 LEFT JOIN jsonb_array_elements({:dataEachTEST}::jsonb) "__dataEach_select_many_je" ON 1=1 LEFT JOIN jsonb_array_elements({:dataEachTEST}::jsonb) "__dataEach_file_one_je" ON 1=1 LEFT JOIN jsonb_array_elements({:dataEachTEST}::jsonb) "__dataEach_file_many_je" ON 1=1 LEFT JOIN jsonb_array_elements({:dataEachTEST}::jsonb) "__dataEach_rel_one_je" ON 1=1 LEFT JOIN jsonb_array_elements({:dataEachTEST}::jsonb) "__dataEach_rel_many_je" ON 1=1 WHERE ([[__dataEach_select_one_je.value]] > TRUE AND [[__dataEach_select_one_je.value]] < TRUE AND (([[__dataEach_select_many_je.value]] > TRUE) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm__dataEach_select_many_je.value]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN jsonb_array_elements({:mmdataEachTEST}::jsonb) "__mm__dataEach_select_many_je" ON 1=1 WHERE "__mm_demo1"."id" = "demo1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > TRUE)))) AND [[__dataEach_select_many_je.value]] < TRUE AND [[__dataEach_file_one_je.value]] > TRUE AND [[__dataEach_file_one_je.value]] < TRUE AND (([[__dataEach_file_many_je.value]] > TRUE) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm__dataEach_file_many_je.value]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN jsonb_array_elements({:mmdataEachTEST}::jsonb) "__mm__dataEach_file_many_je" ON 1=1 WHERE "__mm_demo1"."id" = "demo1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > TRUE)))) AND [[__dataEach_file_many_je.value]] < TRUE AND [[__dataEach_rel_one_je.value]] > TRUE AND [[__dataEach_rel_one_je.value]] < TRUE AND (([[__dataEach_rel_many_je.value]] > TRUE) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm__dataEach_rel_many_je.value]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN jsonb_array_elements({:mmdataEachTEST}::jsonb) "__mm__dataEach_rel_many_je" ON 1=1 WHERE "__mm_demo1"."id" = "demo1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > TRUE)))) AND [[__dataEach_rel_many_je.value]] < TRUE)`,
		},
		{
		...
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo1".* FROM "demo1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[demo1.select_one]] IS JSON OR json_valid([[demo1.select_one]]::text)) AND jsonb_typeof([[demo1.select_one]]::jsonb) = 'array' THEN [[demo1.select_one]]::jsonb ELSE jsonb_build_array([[demo1.select_one]]) END) "demo1_select_one_je" ON 1=1 LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[demo1.select_many]] IS JSON OR json_valid([[demo1.select_many]]::text)) AND jsonb_typeof([[demo1.select_many]]::jsonb) = 'array' THEN [[demo1.select_many]]::jsonb ELSE jsonb_build_array([[demo1.select_many]]) END) "demo1_select_many_je" ON 1=1 LEFT JOIN jsonb_array_elements({:dataEachTEST}::jsonb) "__dataEach_select_many_je" ON 1=1 WHERE (((to_jsonb([[demo1_select_one_je.value]]) IS DISTINCT FROM to_jsonb([[demo1_select_many_je.value]])) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo1_select_many_je.value]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo1.select_many]] IS JSON OR json_valid([[__mm_demo1.select_many]]::text)) AND jsonb_typeof([[__mm_demo1.select_many]]::jsonb) = 'array' THEN [[__mm_demo1.select_many]]::jsonb ELSE jsonb_build_array([[__mm_demo1.select_many]]) END) "__mm_demo1_select_many_je" ON 1=1 WHERE "__mm_demo1"."id" = "demo1"."id") {{__smTEST}} WHERE NOT (to_jsonb([[demo1_select_one_je.value]]) IS DISTINCT FROM to_jsonb([[__smTEST.multiMatchValue]]))))) AND (([[demo1_select_many_je.value]] > [[demo1_select_one_je.value]]) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo1_select_many_je.value]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo1.select_many]] IS JSON OR json_valid([[__mm_demo1.select_many]]::text)) AND jsonb_typeof([[__mm_demo1.select_many]]::jsonb) = 'array' THEN [[__mm_demo1.select_many]]::jsonb ELSE jsonb_build_array([[__mm_demo1.select_many]]) END) "__mm_demo1_select_many_je" ON 1=1 WHERE "__mm_demo1"."id" = "demo1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > [[demo1_select_one_je.value]])))) AND [[demo1_select_many_je.value]] < [[demo1_select_one_je.value]] AND (([[demo1_select_many_je.value]] = [[__dataEach_select_many_je.value]]) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo1_select_many_je.value]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo1.select_many]] IS JSON OR json_valid([[__mm_demo1.select_many]]::text)) AND jsonb_typeof([[__mm_demo1.select_many]]::jsonb) = 'array' THEN [[__mm_demo1.select_many]]::jsonb ELSE jsonb_build_array([[__mm_demo1.select_many]]) END) "__mm_demo1_select_many_je" ON 1=1 WHERE "__mm_demo1"."id" = "demo1"."id") {{__mlTEST}} LEFT JOIN (SELECT [[__mm__dataEach_select_many_je.value]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN jsonb_array_elements({:mmdataEachTEST}::jsonb) "__mm__dataEach_select_many_je" ON 1=1 WHERE "__mm_demo1"."id" = "demo1"."id") {{__mrTEST}} ON 1 = 1 WHERE NOT (to_jsonb([[__mlTEST.multiMatchValue]]) IS NOT DISTINCT FROM to_jsonb([[__mrTEST.multiMatchValue]]))))))`,
		},
		{
		...
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo4".* FROM "demo4" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[demo4.self_rel_many]] IS JSON OR json_valid([[demo4.self_rel_many]]::text)) AND jsonb_typeof([[demo4.self_rel_many]]::jsonb) = 'array' THEN [[demo4.self_rel_many]]::jsonb ELSE jsonb_build_array([[demo4.self_rel_many]]) END) "demo4_self_rel_many_je" ON 1=1 LEFT JOIN "demo4" "demo4_self_rel_many" ON [[demo4_self_rel_many.id]] = [[demo4_self_rel_many_je.value]] WHERE (JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb IS NOT DISTINCT FROM to_jsonb(''::text) OR JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb IS DISTINCT FROM to_jsonb(''::text) OR to_jsonb(''::text) IS NOT DISTINCT FROM JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb OR to_jsonb(''::text) IS DISTINCT FROM JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb OR JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb IS NOT DISTINCT FROM to_jsonb(NULL::text) OR JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb IS DISTINCT FROM to_jsonb(NULL::text) OR to_jsonb(NULL::text) IS NOT DISTINCT FROM JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb OR to_jsonb(NULL::text) IS DISTINCT FROM JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb OR JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb IS NOT DISTINCT FROM to_jsonb(TRUE) OR JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb IS DISTINCT FROM to_jsonb(TRUE) OR to_jsonb(TRUE) IS NOT DISTINCT FROM JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb OR to_jsonb(TRUE) IS DISTINCT FROM JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb OR JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb IS NOT DISTINCT FROM JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb OR JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb IS DISTINCT FROM JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb OR JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb IS NOT DISTINCT FROM to_jsonb([[demo4.title]]) OR to_jsonb([[demo4.title]]) IS DISTINCT FROM JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb OR ((JSON_QUERY_OR_NULL([[demo4_self_rel_many.json_object]], '$')::jsonb IS NOT DISTINCT FROM to_jsonb(''::text)) AND (NOT EXISTS (SELECT 1 FROM (SELECT JSON_QUERY_OR_NULL([[__mm_demo4_self_rel_many.json_object]], '$')::jsonb as [[multiMatchValue]] FROM "demo4" "__mm_demo4" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo4.self_rel_many]] IS JSON OR json_valid([[__mm_demo4.self_rel_many]]::text)) AND jsonb_typeof([[__mm_demo4.self_rel_many]]::jsonb) = 'array' THEN [[__mm_demo4.self_rel_many]]::jsonb ELSE jsonb_build_array([[__mm_demo4.self_rel_many]]) END) "__mm_demo4_self_rel_many_je" ON 1=1 LEFT JOIN "demo4" "__mm_demo4_self_rel_many" ON [[__mm_demo4_self_rel_many.id]] = [[__mm_demo4_self_rel_many_je.value]] WHERE "__mm_demo4"."id" = "demo4"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] IS NOT DISTINCT FROM '')))) OR ((to_jsonb(NULL::text) IS NOT DISTINCT FROM JSON_QUERY_OR_NULL([[demo4_self_rel_many.json_object]], '$')::jsonb) AND (NOT EXISTS (SELECT 1 FROM (SELECT JSON_QUERY_OR_NULL([[__mm_demo4_self_rel_many.json_object]], '$')::jsonb as [[multiMatchValue]] FROM "demo4" "__mm_demo4" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo4.self_rel_many]] IS JSON OR json_valid([[__mm_demo4.self_rel_many]]::text)) AND jsonb_typeof([[__mm_demo4.self_rel_many]]::jsonb) = 'array' THEN [[__mm_demo4.self_rel_many]]::jsonb ELSE jsonb_build_array([[__mm_demo4.self_rel_many]]) END) "__mm_demo4_self_rel_many_je" ON 1=1 LEFT JOIN "demo4" "__mm_demo4_self_rel_many" ON [[__mm_demo4_self_rel_many.id]] = [[__mm_demo4_self_rel_many_je.value]] WHERE "__mm_demo4"."id" = "demo4"."id") {{__smTEST}} WHERE NOT (NULL IS NOT DISTINCT FROM [[__smTEST.multiMatchValue]])))) OR ((JSON_QUERY_OR_NULL([[demo4_self_rel_many.json_object]], '$')::jsonb IS NOT DISTINCT FROM JSON_QUERY_OR_NULL([[demo4_self_rel_many.json_object]], '$')::jsonb) AND (NOT EXISTS (SELECT 1 FROM (SELECT JSON_QUERY_OR_NULL([[__mm_demo4_self_rel_many.json_object]], '$')::jsonb as [[multiMatchValue]] FROM "demo4" "__mm_demo4" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo4.self_rel_many]] IS JSON OR json_valid([[__mm_demo4.self_rel_many]]::text)) AND jsonb_typeof([[__mm_demo4.self_rel_many]]::jsonb) = 'array' THEN [[__mm_demo4.self_rel_many]]::jsonb ELSE jsonb_build_array([[__mm_demo4.self_rel_many]]) END) "__mm_demo4_self_rel_many_je" ON 1=1 LEFT JOIN "demo4" "__mm_demo4_self_rel_many" ON [[__mm_demo4_self_rel_many.id]] = [[__mm_demo4_self_rel_many_je.value]] WHERE "__mm_demo4"."id" = "demo4"."id") {{__mlTEST}} LEFT JOIN (SELECT JSON_QUERY_OR_NULL([[__mm_demo4_self_rel_many.json_object]], '$')::jsonb as [[multiMatchValue]] FROM "demo4" "__mm_demo4" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo4.self_rel_many]] IS JSON OR json_valid([[__mm_demo4.self_rel_many]]::text)) AND jsonb_typeof([[__mm_demo4.self_rel_many]]::jsonb) = 'array' THEN [[__mm_demo4.self_rel_many]]::jsonb ELSE jsonb_build_array([[__mm_demo4.self_rel_many]]) END) "__mm_demo4_self_rel_many_je" ON 1=1 LEFT JOIN "demo4" "__mm_demo4_self_rel_many" ON [[__mm_demo4_self_rel_many.id]] = [[__mm_demo4_self_rel_many_je.value]] WHERE "__mm_demo4"."id" = "demo4"."id") {{__mrTEST}} ON 1 = 1 WHERE NOT ([[__mlTEST.multiMatchValue]] IS NOT DISTINCT FROM [[__mrTEST.multiMatchValue]])))))`,
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT "demo1".* FROM "demo1" WHERE (([[demo1.point]]::text = '' OR [[demo1.point]] IS NULL) OR JSON_QUERY_OR_NULL([[demo1.point]], '$.lat')::jsonb > 1 OR JSON_QUERY_OR_NULL([[demo1.point]], '$.lon')::jsonb < 2 OR JSON_QUERY_OR_NULL([[demo1.point]], '$.something')::jsonb > 3)`,
		},
	}
