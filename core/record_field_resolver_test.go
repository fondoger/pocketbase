...
func TestRecordFieldResolverUpdateQuery(t *testing.T) {
	...
	scenarios := []struct {
	...
	}{
		{
			...
			*/
			// PostgreSQL:
			`SELECT "demo4".* FROM "demo4" WHERE ([[demo4.title]] = TRUE OR [[demo4.title]] IS DISTINCT FROM {:TEST} OR [[demo4.title]]::text LIKE {:TEST} ESCAPE '\' OR [[demo4.title]]::text NOT LIKE {:TEST} ESCAPE '\' OR [[demo4.title]] > 1 OR [[demo4.title]] >= 2 OR [[demo4.title]] < 3 OR [[demo4.title]] <= 4)`,
		},
		{
		...
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo4".* FROM "demo4" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[demo4.self_rel_many]] IS JSON OR json_valid([[demo4.self_rel_many]]::text)) AND jsonb_typeof([[demo4.self_rel_many]]::jsonb) = 'array' THEN [[demo4.self_rel_many]]::jsonb ELSE jsonb_build_array([[demo4.self_rel_many]]) END) "__je_demo4_self_rel_many" ON 1=1 LEFT JOIN "demo4" "demo4_self_rel_many" ON [[demo4_self_rel_many.id]] = [[__je_demo4_self_rel_many.value]] WHERE [[demo4_self_rel_many.id]] > TRUE`,
		},
		{
		...
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo4".* FROM "demo4" LEFT JOIN "demo3" "demo4_rel_one_cascade" ON [[demo4_rel_one_cascade.id]] = [[demo4.rel_one_cascade]] WHERE (({:TEST} IS DISTINCT FROM '' AND {:TEST} IS DISTINCT FROM {:TEST})) AND ([[demo4_rel_one_cascade.created]] > TRUE)`,
		},
		{
		...
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo1".* FROM "demo1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[demo1.rel_many]] IS JSON OR json_valid([[demo1.rel_many]]::text)) AND jsonb_typeof([[demo1.rel_many]]::jsonb) = 'array' THEN [[demo1.rel_many]]::jsonb ELSE jsonb_build_array([[demo1.rel_many]]) END) "__je_demo1_rel_many" ON 1=1 LEFT JOIN "users" "demo1_rel_many" ON [[demo1_rel_many.id]] = [[__je_demo1_rel_many.value]] WHERE [[demo1_rel_many.created]] > TRUE`,
		},
		{
		...
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo4".* FROM "demo4" LEFT JOIN "demo4" "demo4_self_rel_one" ON [[demo4_self_rel_one.id]] = [[demo4.self_rel_one]] LEFT JOIN "demo3" "demo4_self_rel_one_rel_one_cascade" ON [[demo4_self_rel_one_rel_one_cascade.id]] = [[demo4_self_rel_one.rel_one_cascade]] WHERE (({:TEST} IS DISTINCT FROM '' AND {:TEST} IS DISTINCT FROM {:TEST})) AND ([[demo4_self_rel_one_rel_one_cascade.created]] > TRUE)`,
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo4".* FROM "demo4" LEFT JOIN "demo4" "demo4_self_rel_one" ON [[demo4_self_rel_one.id]] = [[demo4.self_rel_one]] LEFT JOIN "demo3" "demo4_self_rel_one_rel_one_cascade" ON [[demo4_self_rel_one_rel_one_cascade.id]] = [[demo4_self_rel_one.rel_one_cascade]] WHERE (({:TEST} IS DISTINCT FROM '' AND {:TEST} IS DISTINCT FROM {:TEST})) AND (([[demo4_self_rel_one_rel_one_cascade.created]] > TRUE AND [[demo4_self_rel_one_rel_one_cascade.updated]] > TRUE))`,
		},
		{
		...
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo4".* FROM "demo4" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[demo4.self_rel_many]] IS JSON OR json_valid([[demo4.self_rel_many]]::text)) AND jsonb_typeof([[demo4.self_rel_many]]::jsonb) = 'array' THEN [[demo4.self_rel_many]]::jsonb ELSE jsonb_build_array([[demo4.self_rel_many]]) END) "__je_demo4_self_rel_many" ON 1=1 LEFT JOIN "demo4" "demo4_self_rel_many" ON [[demo4_self_rel_many.id]] = [[__je_demo4_self_rel_many.value]] LEFT JOIN "demo4" "demo4_self_rel_many_self_rel_one" ON [[demo4_self_rel_many_self_rel_one.id]] = [[demo4_self_rel_many.self_rel_one]] WHERE [[demo4_self_rel_many_self_rel_one.title]] > TRUE`,
		},
		{
		...
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo4".* FROM "demo4" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[demo4.self_rel_many]] IS JSON OR json_valid([[demo4.self_rel_many]]::text)) AND jsonb_typeof([[demo4.self_rel_many]]::jsonb) = 'array' THEN [[demo4.self_rel_many]]::jsonb ELSE jsonb_build_array([[demo4.self_rel_many]]) END) "__je_demo4_self_rel_many" ON 1=1 LEFT JOIN "demo4" "demo4_self_rel_many" ON [[demo4_self_rel_many.id]] = [[__je_demo4_self_rel_many.value]] LEFT JOIN "demo4" "demo4_self_rel_one" ON [[demo4_self_rel_one.id]] = [[demo4.self_rel_one]] WHERE ([[demo4_self_rel_many.title]] = {:TEST} OR JSON_QUERY_OR_NULL([[demo4_self_rel_one.json_object]], '$.a')::jsonb::text > TRUE::text)`,
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo4".* FROM "demo4" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[demo4.self_rel_many]] IS JSON OR json_valid([[demo4.self_rel_many]]::text)) AND jsonb_typeof([[demo4.self_rel_many]]::jsonb) = 'array' THEN [[demo4.self_rel_many]]::jsonb ELSE jsonb_build_array([[demo4.self_rel_many]]) END) "__je_demo4_self_rel_many" ON 1=1 LEFT JOIN "demo4" "demo4_self_rel_many" ON [[demo4_self_rel_many.id]] = [[__je_demo4_self_rel_many.value]] LEFT JOIN "demo4" "demo4_self_rel_one" ON [[demo4_self_rel_one.id]] = [[demo4.self_rel_one]] WHERE ((([[demo4_self_rel_many.title]] = {:TEST}) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo4_self_rel_many.title]] as [[multiMatchValue]] FROM "demo4" "__mm_demo4" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo4.self_rel_many]] IS JSON OR json_valid([[__mm_demo4.self_rel_many]]::text)) AND jsonb_typeof([[__mm_demo4.self_rel_many]]::jsonb) = 'array' THEN [[__mm_demo4.self_rel_many]]::jsonb ELSE jsonb_build_array([[__mm_demo4.self_rel_many]]) END) "__mm_demo4_self_rel_many_je" ON 1=1 LEFT JOIN "demo4" "__mm_demo4_self_rel_many" ON [[__mm_demo4_self_rel_many.id]] = [[__mm_demo4_self_rel_many_je.value]] WHERE "__mm_demo4"."id" = "demo4"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] = {:TEST})))) OR JSON_QUERY_OR_NULL([[demo4_self_rel_one.json_object]], '$.a')::jsonb::text > TRUE::text)`,
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo3".* FROM "demo3" LEFT JOIN "demo4" "demo3_demo4_via_rel_one_cascade" ON [[demo3.id]] IN (SELECT [[__je_demo3_demo4_via_rel_one_cascade.value]] FROM jsonb_array_elements_text(CASE WHEN ([[demo3_demo4_via_rel_one_cascade.rel_one_cascade]] IS JSON OR json_valid([[demo3_demo4_via_rel_one_cascade.rel_one_cascade]]::text)) AND jsonb_typeof([[demo3_demo4_via_rel_one_cascade.rel_one_cascade]]::jsonb) = 'array' THEN [[demo3_demo4_via_rel_one_cascade.rel_one_cascade]]::jsonb ELSE jsonb_build_array([[demo3_demo4_via_rel_one_cascade.rel_one_cascade]]) END) {{__je_demo3_demo4_via_rel_one_cascade}}) WHERE ((([[demo3_demo4_via_rel_one_cascade.id]] = TRUE) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo3_demo4_via_rel_one_cascade.id]] as [[multiMatchValue]] FROM "demo3" "__mm_demo3" LEFT JOIN "demo4" "__mm_demo3_demo4_via_rel_one_cascade" ON [[__mm_demo3.id]] IN (SELECT [[__je___mm_demo3_demo4_via_rel_one_cascade.value]] FROM jsonb_array_elements_text(CASE WHEN ([[__mm_demo3_demo4_via_rel_one_cascade.rel_one_cascade]] IS JSON OR json_valid([[__mm_demo3_demo4_via_rel_one_cascade.rel_one_cascade]]::text)) AND jsonb_typeof([[__mm_demo3_demo4_via_rel_one_cascade.rel_one_cascade]]::jsonb) = 'array' THEN [[__mm_demo3_demo4_via_rel_one_cascade.rel_one_cascade]]::jsonb ELSE jsonb_build_array([[__mm_demo3_demo4_via_rel_one_cascade.rel_one_cascade]]) END) {{__je___mm_demo3_demo4_via_rel_one_cascade}}) WHERE "__mm_demo3"."id" = "demo3"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] = TRUE)))))`,
		},
		{
		...
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo3".* FROM "demo3" LEFT JOIN "demo4" "demo3_demo4_via_rel_many_cascade" ON [[demo3.id]] IN (SELECT [[__je_demo3_demo4_via_rel_many_cascade.value]] FROM jsonb_array_elements_text(CASE WHEN ([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]] IS JSON OR json_valid([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]::text)) AND jsonb_typeof([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]::jsonb) = 'array' THEN [[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]::jsonb ELSE jsonb_build_array([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]) END) {{__je_demo3_demo4_via_rel_many_cascade}}) WHERE [[demo3_demo4_via_rel_many_cascade.id]] = TRUE`,
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo3".* FROM "demo3" LEFT JOIN "demo4" "demo3_demo4_via_rel_many_cascade" ON [[demo3.id]] IN (SELECT [[__je_demo3_demo4_via_rel_many_cascade.value]] FROM jsonb_array_elements_text(CASE WHEN ([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]] IS JSON OR json_valid([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]::text)) AND jsonb_typeof([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]::jsonb) = 'array' THEN [[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]::jsonb ELSE jsonb_build_array([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]) END) {{__je_demo3_demo4_via_rel_many_cascade}}) WHERE ((([[demo3_demo4_via_rel_many_cascade.id]] = TRUE) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo3_demo4_via_rel_many_cascade.id]] as [[multiMatchValue]] FROM "demo3" "__mm_demo3" LEFT JOIN "demo4" "__mm_demo3_demo4_via_rel_many_cascade" ON [[__mm_demo3.id]] IN (SELECT [[__je___mm_demo3_demo4_via_rel_many_cascade.value]] FROM jsonb_array_elements_text(CASE WHEN ([[__mm_demo3_demo4_via_rel_many_cascade.rel_many_cascade]] IS JSON OR json_valid([[__mm_demo3_demo4_via_rel_many_cascade.rel_many_cascade]]::text)) AND jsonb_typeof([[__mm_demo3_demo4_via_rel_many_cascade.rel_many_cascade]]::jsonb) = 'array' THEN [[__mm_demo3_demo4_via_rel_many_cascade.rel_many_cascade]]::jsonb ELSE jsonb_build_array([[__mm_demo3_demo4_via_rel_many_cascade.rel_many_cascade]]) END) {{__je___mm_demo3_demo4_via_rel_many_cascade}}) WHERE "__mm_demo3"."id" = "demo3"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] = TRUE)))))`,
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo3".* FROM "demo3" LEFT JOIN "demo4" "demo3_demo4_via_rel_many_unique" ON [[demo3.id]] IN (SELECT [[__je_demo3_demo4_via_rel_many_unique.value]] FROM jsonb_array_elements_text(CASE WHEN ([[demo3_demo4_via_rel_many_unique.rel_many_unique]] IS JSON OR json_valid([[demo3_demo4_via_rel_many_unique.rel_many_unique]]::text)) AND jsonb_typeof([[demo3_demo4_via_rel_many_unique.rel_many_unique]]::jsonb) = 'array' THEN [[demo3_demo4_via_rel_many_unique.rel_many_unique]]::jsonb ELSE jsonb_build_array([[demo3_demo4_via_rel_many_unique.rel_many_unique]]) END) {{__je_demo3_demo4_via_rel_many_unique}}) WHERE ((([[demo3_demo4_via_rel_many_unique.id]] = TRUE) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo3_demo4_via_rel_many_unique.id]] as [[multiMatchValue]] FROM "demo3" "__mm_demo3" LEFT JOIN "demo4" "__mm_demo3_demo4_via_rel_many_unique" ON [[__mm_demo3.id]] IN (SELECT [[__je___mm_demo3_demo4_via_rel_many_unique.value]] FROM jsonb_array_elements_text(CASE WHEN ([[__mm_demo3_demo4_via_rel_many_unique.rel_many_unique]] IS JSON OR json_valid([[__mm_demo3_demo4_via_rel_many_unique.rel_many_unique]]::text)) AND jsonb_typeof([[__mm_demo3_demo4_via_rel_many_unique.rel_many_unique]]::jsonb) = 'array' THEN [[__mm_demo3_demo4_via_rel_many_unique.rel_many_unique]]::jsonb ELSE jsonb_build_array([[__mm_demo3_demo4_via_rel_many_unique.rel_many_unique]]) END) {{__je___mm_demo3_demo4_via_rel_many_unique}}) WHERE "__mm_demo3"."id" = "demo3"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] = TRUE)))))`,
		},
		{
		...
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo1".* FROM "demo1" LEFT JOIN "view1" "demo1_view1_via_rel_one" ON [[demo1.id]] IN (SELECT [[__je_demo1_view1_via_rel_one.value]] FROM jsonb_array_elements_text(CASE WHEN ([[demo1_view1_via_rel_one.rel_one]] IS JSON OR json_valid([[demo1_view1_via_rel_one.rel_one]]::text)) AND jsonb_typeof([[demo1_view1_via_rel_one.rel_one]]::jsonb) = 'array' THEN [[demo1_view1_via_rel_one.rel_one]]::jsonb ELSE jsonb_build_array([[demo1_view1_via_rel_one.rel_one]]) END) {{__je_demo1_view1_via_rel_one}}) LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[demo1_view1_via_rel_one.rel_many]] IS JSON OR json_valid([[demo1_view1_via_rel_one.rel_many]]::text)) AND jsonb_typeof([[demo1_view1_via_rel_one.rel_many]]::jsonb) = 'array' THEN [[demo1_view1_via_rel_one.rel_many]]::jsonb ELSE jsonb_build_array([[demo1_view1_via_rel_one.rel_many]]) END) "__je_demo1_view1_via_rel_one_rel_many" ON 1=1 LEFT JOIN "users" "demo1_view1_via_rel_one_rel_many" ON [[demo1_view1_via_rel_one_rel_many.id]] = [[__je_demo1_view1_via_rel_one_rel_many.value]] WHERE [[demo1_view1_via_rel_one_rel_many.created]] > TRUE`,
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo3".* FROM "demo3" LEFT JOIN "demo4" "demo3_demo4_via_rel_many_cascade" ON [[demo3.id]] IN (SELECT [[__je_demo3_demo4_via_rel_many_cascade.value]] FROM jsonb_array_elements_text(CASE WHEN ([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]] IS JSON OR json_valid([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]::text)) AND jsonb_typeof([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]::jsonb) = 'array' THEN [[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]::jsonb ELSE jsonb_build_array([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]) END) {{__je_demo3_demo4_via_rel_many_cascade}}) LEFT JOIN "demo3" "demo3_demo4_via_rel_many_cascade_rel_one_cascade" ON [[demo3_demo4_via_rel_many_cascade_rel_one_cascade.id]] = [[demo3_demo4_via_rel_many_cascade.rel_one_cascade]] LEFT JOIN "demo4" "demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade" ON [[demo3_demo4_via_rel_many_cascade_rel_one_cascade.id]] IN (SELECT [[__je_demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade.value]] FROM jsonb_array_elements_text(CASE WHEN ([[demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade.rel_many_cascade]] IS JSON OR json_valid([[demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade.rel_many_cascade]]::text)) AND jsonb_typeof([[demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade.rel_many_cascade]]::jsonb) = 'array' THEN [[demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade.rel_many_cascade]]::jsonb ELSE jsonb_build_array([[demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade.rel_many_cascade]]) END) {{__je_demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade}}) WHERE (({:TEST} IS DISTINCT FROM '' AND {:TEST} IS DISTINCT FROM {:TEST})) AND ([[demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade.id]] = TRUE)`,
		},
		{
		...
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo4".* FROM "demo4" LEFT JOIN "demo1" "__collection_demo1" ON 1=1 LEFT JOIN "demo2" "__collection_demo2" ON 1=1 LEFT JOIN "demo1" "__collection_alias_demo1_alias" ON 1=1 WHERE ([[__collection_demo1.text]] > TRUE OR [[__collection_demo2.active]] > TRUE OR [[__collection_alias_demo1_alias.file_one]] > TRUE)`,
		},
		{
		...
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT "demo4".* FROM "demo4" WHERE ({:TEST} = TRUE OR '' = TRUE OR {:TEST} = TRUE OR NULL = TRUE OR {:TEST} = TRUE OR NULL = TRUE)`,
		},
		{
		...
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo4".* FROM "demo4" LEFT JOIN "nologin" "__collection_nologin" ON 1=1 WHERE ((((([[__collection_nologin.email]] > TRUE) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm___collection_nologin.email]] as [[multiMatchValue]] FROM "demo4" "__mm_demo4" LEFT JOIN "nologin" "__mm___collection_nologin" ON 1=1 WHERE "__mm_demo4"."id" = "demo4"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > TRUE))))) AND ([[__collection_nologin.emailVisibility]] = TRUE)) OR {:TEST} > TRUE)`,
		},
		{
		...
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo4".* FROM "demo4" LEFT JOIN "demo3" "__collection_demo3" ON 1=1 WHERE (({:TEST} IS DISTINCT FROM '' AND {:TEST} IS DISTINCT FROM {:TEST})) AND (((([[__collection_demo3.title]] > TRUE) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm___collection_demo3.title]] as [[multiMatchValue]] FROM "demo4" "__mm_demo4" LEFT JOIN "demo3" "__mm___collection_demo3" ON 1=1 WHERE "__mm_demo4"."id" = "demo4"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > TRUE))))))`,
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo4".* FROM "demo4" LEFT JOIN "demo3" "__collection_demo3" ON 1=1 WHERE ((([[__collection_demo3.title]] > TRUE) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm___collection_demo3.title]] as [[multiMatchValue]] FROM "demo4" "__mm_demo4" LEFT JOIN "demo3" "__mm___collection_demo3" ON 1=1 WHERE "__mm_demo4"."id" = "demo4"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > TRUE)))))`,
		},
		{
			...
			*/
			`SELECT DISTINCT "demo1".* FROM "demo1" LEFT JOIN "users" "__data_users_rel_many" ON [[__data_users_rel_many.id]] IN ({:p0}, {:p1}) LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[demo1.rel_many]] IS JSON OR json_valid([[demo1.rel_many]]::text)) AND jsonb_typeof([[demo1.rel_many]]::jsonb) = 'array' THEN [[demo1.rel_many]]::jsonb ELSE jsonb_build_array([[demo1.rel_many]]) END) "__je_demo1_rel_many" ON 1=1 LEFT JOIN "users" "demo1_rel_many" ON [[demo1_rel_many.id]] = [[__je_demo1_rel_many.value]] WHERE (LOWER({:infoLowerrel_oneTEST}) > TRUE OR LOWER({:infoLowerrel_manyTEST}) > TRUE OR ((LOWER([[__data_users_rel_many.email]]) > TRUE) AND (NOT EXISTS (SELECT 1 FROM (SELECT LOWER([[__mm___data_users_rel_many.email]]) as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN "users" "__mm___data_users_rel_many" ON [[__mm___data_users_rel_many.id]] IN ({:p4}, {:p5}) WHERE "__mm_demo1"."id" = "demo1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > TRUE)))) OR LOWER([[demo1.text]]) > TRUE OR LOWER([[demo1.bool]]) > TRUE OR LOWER([[demo1.url]]) > TRUE OR LOWER([[demo1.select_one]]) > TRUE OR LOWER([[demo1.select_many]]) > TRUE OR LOWER([[demo1.file_one]]) > TRUE OR LOWER([[demo1.file_many]]) > TRUE OR LOWER([[demo1.number]]) > TRUE OR LOWER([[demo1.email]]) > TRUE OR LOWER([[demo1.datetime]]) > TRUE OR LOWER(JSON_QUERY_OR_NULL([[demo1.json]], '$')::jsonb) > TRUE OR LOWER([[demo1.rel_one]]) > TRUE OR LOWER([[demo1.rel_many]]) > TRUE OR ((LOWER([[demo1_rel_many.name]]) > TRUE) AND (NOT EXISTS (SELECT 1 FROM (SELECT LOWER([[__mm_demo1_rel_many.name]]) as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo1.rel_many]] IS JSON OR json_valid([[__mm_demo1.rel_many]]::text)) AND jsonb_typeof([[__mm_demo1.rel_many]]::jsonb) = 'array' THEN [[__mm_demo1.rel_many]]::jsonb ELSE jsonb_build_array([[__mm_demo1.rel_many]]) END) "__mm_demo1_rel_many_je" ON 1=1 LEFT JOIN "users" "__mm_demo1_rel_many" ON [[__mm_demo1_rel_many.id]] = [[__mm_demo1_rel_many_je.value]] WHERE "__mm_demo1"."id" = "demo1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > TRUE)))) OR LOWER([[demo1.created]]) > TRUE)`,
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT "demo1".* FROM "demo1" WHERE (NULL > TRUE OR LOWER({:TEST}) > TRUE OR NULL > TRUE OR '' > TRUE OR LOWER({:TEST}) > TRUE OR NULL > TRUE OR LOWER({:TEST}) > TRUE OR NULL > TRUE)`,
		},
		{
			"isset modifier",
			"demo1",
		...
		},
		{
			...
			*/
			`SELECT DISTINCT "demo4".* FROM "demo4" LEFT JOIN "demo3" "__data_demo3_rel_one_cascade" ON [[__data_demo3_rel_one_cascade.id]]={:p0} LEFT JOIN "demo3" "__data_demo3_rel_one_no_cascade" ON [[__data_demo3_rel_one_no_cascade.id]]={:p1} LEFT JOIN "demo4" "__data_demo4_self_rel_many" ON [[__data_demo4_self_rel_many.id]]={:p2} WHERE ((({:TEST} IS DISTINCT FROM '' AND {:TEST} IS DISTINCT FROM {:TEST})) AND (({:TEST} IS DISTINCT FROM '' AND {:TEST} IS DISTINCT FROM {:TEST}))) AND (([[__data_demo3_rel_one_cascade.title]] > TRUE AND [[__data_demo3_rel_one_no_cascade.title]] < TRUE AND (([[__data_demo4_self_rel_many.title]] = TRUE) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm___data_demo4_self_rel_many.title]] as [[multiMatchValue]] FROM "demo4" "__mm_demo4" LEFT JOIN "demo4" "__mm___data_demo4_self_rel_many" ON [[__mm___data_demo4_self_rel_many.id]]={:p9} WHERE "__mm_demo4"."id" = "demo4"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] = TRUE))))))`,
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo1".* FROM "demo1" LEFT JOIN jsonb_array_elements({:dataEachTEST}::jsonb) "__dataEach_je_select_one" ON 1=1 LEFT JOIN jsonb_array_elements({:dataEachTEST}::jsonb) "__dataEach_je_select_many" ON 1=1 LEFT JOIN jsonb_array_elements({:dataEachTEST}::jsonb) "__dataEach_je_file_one" ON 1=1 LEFT JOIN jsonb_array_elements({:dataEachTEST}::jsonb) "__dataEach_je_file_many" ON 1=1 LEFT JOIN jsonb_array_elements({:dataEachTEST}::jsonb) "__dataEach_je_rel_one" ON 1=1 LEFT JOIN jsonb_array_elements({:dataEachTEST}::jsonb) "__dataEach_je_rel_many" ON 1=1 WHERE ([[__dataEach_je_select_one.value]] > TRUE AND [[__dataEach_je_select_one.value]] < TRUE AND (([[__dataEach_je_select_many.value]] > TRUE) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm___dataEach_je_select_many.value]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN jsonb_array_elements({:mmdataEachTEST}::jsonb) "__mm___dataEach_je_select_many" ON 1=1 WHERE "__mm_demo1"."id" = "demo1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > TRUE)))) AND [[__dataEach_je_select_many.value]] < TRUE AND [[__dataEach_je_file_one.value]] > TRUE AND [[__dataEach_je_file_one.value]] < TRUE AND (([[__dataEach_je_file_many.value]] > TRUE) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm___dataEach_je_file_many.value]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN jsonb_array_elements({:mmdataEachTEST}::jsonb) "__mm___dataEach_je_file_many" ON 1=1 WHERE "__mm_demo1"."id" = "demo1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > TRUE)))) AND [[__dataEach_je_file_many.value]] < TRUE AND [[__dataEach_je_rel_one.value]] > TRUE AND [[__dataEach_je_rel_one.value]] < TRUE AND (([[__dataEach_je_rel_many.value]] > TRUE) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm___dataEach_je_rel_many.value]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN jsonb_array_elements({:mmdataEachTEST}::jsonb) "__mm___dataEach_je_rel_many" ON 1=1 WHERE "__mm_demo1"."id" = "demo1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > TRUE)))) AND [[__dataEach_je_rel_many.value]] < TRUE)`,
		},
		{
			...
			*/
			`SELECT DISTINCT "view1".* FROM "view1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[view1.select_one]] IS JSON OR json_valid([[view1.select_one]]::text)) AND jsonb_typeof([[view1.select_one]]::jsonb) = 'array' THEN [[view1.select_one]]::jsonb ELSE jsonb_build_array([[view1.select_one]]) END) "__je_view1_select_one" ON 1=1 LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[view1.select_many]] IS JSON OR json_valid([[view1.select_many]]::text)) AND jsonb_typeof([[view1.select_many]]::jsonb) = 'array' THEN [[view1.select_many]]::jsonb ELSE jsonb_build_array([[view1.select_many]]) END) "__je_view1_select_many" ON 1=1 LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[view1.file_one]] IS JSON OR json_valid([[view1.file_one]]::text)) AND jsonb_typeof([[view1.file_one]]::jsonb) = 'array' THEN [[view1.file_one]]::jsonb ELSE jsonb_build_array([[view1.file_one]]) END) "__je_view1_file_one" ON 1=1 LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[view1.file_many]] IS JSON OR json_valid([[view1.file_many]]::text)) AND jsonb_typeof([[view1.file_many]]::jsonb) = 'array' THEN [[view1.file_many]]::jsonb ELSE jsonb_build_array([[view1.file_many]]) END) "__je_view1_file_many" ON 1=1 LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[view1.rel_one]] IS JSON OR json_valid([[view1.rel_one]]::text)) AND jsonb_typeof([[view1.rel_one]]::jsonb) = 'array' THEN [[view1.rel_one]]::jsonb ELSE jsonb_build_array([[view1.rel_one]]) END) "__je_view1_rel_one" ON 1=1 LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[view1.rel_many]] IS JSON OR json_valid([[view1.rel_many]]::text)) AND jsonb_typeof([[view1.rel_many]]::jsonb) = 'array' THEN [[view1.rel_many]]::jsonb ELSE jsonb_build_array([[view1.rel_many]]) END) "__je_view1_rel_many" ON 1=1 WHERE ([[__je_view1_select_one.value]] > TRUE AND [[__je_view1_select_one.value]] < TRUE AND (([[__je_view1_select_many.value]] > TRUE) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__je___mm_view1_select_many.value]] as [[multiMatchValue]] FROM "view1" "__mm_view1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_view1.select_many]] IS JSON OR json_valid([[__mm_view1.select_many]]::text)) AND jsonb_typeof([[__mm_view1.select_many]]::jsonb) = 'array' THEN [[__mm_view1.select_many]]::jsonb ELSE jsonb_build_array([[__mm_view1.select_many]]) END) "__je___mm_view1_select_many" ON 1=1 WHERE "__mm_view1"."id" = "view1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > TRUE)))) AND [[__je_view1_select_many.value]] < TRUE AND [[__je_view1_file_one.value]] > TRUE AND [[__je_view1_file_one.value]] < TRUE AND (([[__je_view1_file_many.value]] > TRUE) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__je___mm_view1_file_many.value]] as [[multiMatchValue]] FROM "view1" "__mm_view1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_view1.file_many]] IS JSON OR json_valid([[__mm_view1.file_many]]::text)) AND jsonb_typeof([[__mm_view1.file_many]]::jsonb) = 'array' THEN [[__mm_view1.file_many]]::jsonb ELSE jsonb_build_array([[__mm_view1.file_many]]) END) "__je___mm_view1_file_many" ON 1=1 WHERE "__mm_view1"."id" = "view1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > TRUE)))) AND [[__je_view1_file_many.value]] < TRUE AND [[__je_view1_rel_one.value]] > TRUE AND [[__je_view1_rel_one.value]] < TRUE AND (([[__je_view1_rel_many.value]] > TRUE) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__je___mm_view1_rel_many.value]] as [[multiMatchValue]] FROM "view1" "__mm_view1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_view1.rel_many]] IS JSON OR json_valid([[__mm_view1.rel_many]]::text)) AND jsonb_typeof([[__mm_view1.rel_many]]::jsonb) = 'array' THEN [[__mm_view1.rel_many]]::jsonb ELSE jsonb_build_array([[__mm_view1.rel_many]]) END) "__je___mm_view1_rel_many" ON 1=1 WHERE "__mm_view1"."id" = "view1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > TRUE)))) AND [[__je_view1_rel_many.value]] < TRUE)`,
		},
		{
			...
			*/
			`SELECT DISTINCT "demo1".* FROM "demo1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[demo1.select_one]] IS JSON OR json_valid([[demo1.select_one]]::text)) AND jsonb_typeof([[demo1.select_one]]::jsonb) = 'array' THEN [[demo1.select_one]]::jsonb ELSE jsonb_build_array([[demo1.select_one]]) END) "__je_demo1_select_one" ON 1=1 LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[demo1.select_many]] IS JSON OR json_valid([[demo1.select_many]]::text)) AND jsonb_typeof([[demo1.select_many]]::jsonb) = 'array' THEN [[demo1.select_many]]::jsonb ELSE jsonb_build_array([[demo1.select_many]]) END) "__je_demo1_select_many" ON 1=1 LEFT JOIN jsonb_array_elements({:dataEachTEST}::jsonb) "__dataEach_je_select_many" ON 1=1 WHERE (((to_jsonb([[__je_demo1_select_one.value]]) IS DISTINCT FROM to_jsonb([[__je_demo1_select_many.value]])) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__je___mm_demo1_select_many.value]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo1.select_many]] IS JSON OR json_valid([[__mm_demo1.select_many]]::text)) AND jsonb_typeof([[__mm_demo1.select_many]]::jsonb) = 'array' THEN [[__mm_demo1.select_many]]::jsonb ELSE jsonb_build_array([[__mm_demo1.select_many]]) END) "__je___mm_demo1_select_many" ON 1=1 WHERE "__mm_demo1"."id" = "demo1"."id") {{__smTEST}} WHERE NOT (to_jsonb([[__je_demo1_select_one.value]]) IS DISTINCT FROM to_jsonb([[__smTEST.multiMatchValue]]))))) AND (([[__je_demo1_select_many.value]] > [[__je_demo1_select_one.value]]) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__je___mm_demo1_select_many.value]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo1.select_many]] IS JSON OR json_valid([[__mm_demo1.select_many]]::text)) AND jsonb_typeof([[__mm_demo1.select_many]]::jsonb) = 'array' THEN [[__mm_demo1.select_many]]::jsonb ELSE jsonb_build_array([[__mm_demo1.select_many]]) END) "__je___mm_demo1_select_many" ON 1=1 WHERE "__mm_demo1"."id" = "demo1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] > [[__je_demo1_select_one.value]])))) AND [[__je_demo1_select_many.value]] < [[__je_demo1_select_one.value]] AND (([[__je_demo1_select_many.value]] = [[__dataEach_je_select_many.value]]) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__je___mm_demo1_select_many.value]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo1.select_many]] IS JSON OR json_valid([[__mm_demo1.select_many]]::text)) AND jsonb_typeof([[__mm_demo1.select_many]]::jsonb) = 'array' THEN [[__mm_demo1.select_many]]::jsonb ELSE jsonb_build_array([[__mm_demo1.select_many]]) END) "__je___mm_demo1_select_many" ON 1=1 WHERE "__mm_demo1"."id" = "demo1"."id") {{__mlTEST}} LEFT JOIN (SELECT [[__mm___dataEach_je_select_many.value]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN jsonb_array_elements({:mmdataEachTEST}::jsonb) "__mm___dataEach_je_select_many" ON 1=1 WHERE "__mm_demo1"."id" = "demo1"."id") {{__mrTEST}} ON 1 = 1 WHERE NOT (to_jsonb([[__mlTEST.multiMatchValue]]) IS NOT DISTINCT FROM to_jsonb([[__mrTEST.multiMatchValue]]))))))`,
		},
		{
		...
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo1".* FROM "demo1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[demo1.rel_many]] IS JSON OR json_valid([[demo1.rel_many]]::text)) AND jsonb_typeof([[demo1.rel_many]]::jsonb) = 'array' THEN [[demo1.rel_many]]::jsonb ELSE jsonb_build_array([[demo1.rel_many]]) END) "__je_demo1_rel_many" ON 1=1 LEFT JOIN "users" "demo1_rel_many" ON [[demo1_rel_many.id]] = [[__je_demo1_rel_many.value]] LEFT JOIN "demo2" "demo1_rel_many_rel" ON [[demo1_rel_many_rel.id]] = [[demo1_rel_many.rel]] LEFT JOIN "demo1" "demo1_rel_one" ON [[demo1_rel_one.id]] = [[demo1.rel_one]] LEFT JOIN "demo2" "__collection_demo2" ON 1=1 LEFT JOIN "users" "__data_users_rel_many" ON [[__data_users_rel_many.id]] IN ({:p0}, {:p1}) WHERE (((to_jsonb([[demo1_rel_many_rel.active]]) IS DISTINCT FROM to_jsonb([[demo1_rel_many.name]])) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo1_rel_many_rel.active]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo1.rel_many]] IS JSON OR json_valid([[__mm_demo1.rel_many]]::text)) AND jsonb_typeof([[__mm_demo1.rel_many]]::jsonb) = 'array' THEN [[__mm_demo1.rel_many]]::jsonb ELSE jsonb_build_array([[__mm_demo1.rel_many]]) END) "__mm_demo1_rel_many_je" ON 1=1 LEFT JOIN "users" "__mm_demo1_rel_many" ON [[__mm_demo1_rel_many.id]] = [[__mm_demo1_rel_many_je.value]] LEFT JOIN "demo2" "__mm_demo1_rel_many_rel" ON [[__mm_demo1_rel_many_rel.id]] = [[__mm_demo1_rel_many.rel]] WHERE "__mm_demo1"."id" = "demo1"."id") {{__mlTEST}} LEFT JOIN (SELECT [[__mm_demo1_rel_many.name]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo1.rel_many]] IS JSON OR json_valid([[__mm_demo1.rel_many]]::text)) AND jsonb_typeof([[__mm_demo1.rel_many]]::jsonb) = 'array' THEN [[__mm_demo1.rel_many]]::jsonb ELSE jsonb_build_array([[__mm_demo1.rel_many]]) END) "__mm_demo1_rel_many_je" ON 1=1 LEFT JOIN "users" "__mm_demo1_rel_many" ON [[__mm_demo1_rel_many.id]] = [[__mm_demo1_rel_many_je.value]] WHERE "__mm_demo1"."id" = "demo1"."id") {{__mrTEST}} ON 1 = 1 WHERE NOT (to_jsonb([[__mlTEST.multiMatchValue]]) IS DISTINCT FROM to_jsonb([[__mrTEST.multiMatchValue]]))))) AND to_jsonb([[demo1_rel_many_rel.active]]) IS NOT DISTINCT FROM to_jsonb([[demo1_rel_many.name]]) AND (([[demo1_rel_many_rel.title]]::text LIKE ('%' || [[demo1_rel_one.email]]::text || '%') ESCAPE '\') AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo1_rel_many_rel.title]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo1.rel_many]] IS JSON OR json_valid([[__mm_demo1.rel_many]]::text)) AND jsonb_typeof([[__mm_demo1.rel_many]]::jsonb) = 'array' THEN [[__mm_demo1.rel_many]]::jsonb ELSE jsonb_build_array([[__mm_demo1.rel_many]]) END) "__mm_demo1_rel_many_je" ON 1=1 LEFT JOIN "users" "__mm_demo1_rel_many" ON [[__mm_demo1_rel_many.id]] = [[__mm_demo1_rel_many_je.value]] LEFT JOIN "demo2" "__mm_demo1_rel_many_rel" ON [[__mm_demo1_rel_many_rel.id]] = [[__mm_demo1_rel_many.rel]] WHERE "__mm_demo1"."id" = "demo1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]]::text LIKE ('%' || [[demo1_rel_one.email]]::text || '%') ESCAPE '\')))) AND ((to_jsonb([[__collection_demo2.active]]) IS NOT DISTINCT FROM to_jsonb([[demo1_rel_many_rel.active]])) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm___collection_demo2.active]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN "demo2" "__mm___collection_demo2" ON 1=1 WHERE "__mm_demo1"."id" = "demo1"."id") {{__mlTEST}} LEFT JOIN (SELECT [[__mm_demo1_rel_many_rel.active]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo1.rel_many]] IS JSON OR json_valid([[__mm_demo1.rel_many]]::text)) AND jsonb_typeof([[__mm_demo1.rel_many]]::jsonb) = 'array' THEN [[__mm_demo1.rel_many]]::jsonb ELSE jsonb_build_array([[__mm_demo1.rel_many]]) END) "__mm_demo1_rel_many_je" ON 1=1 LEFT JOIN "users" "__mm_demo1_rel_many" ON [[__mm_demo1_rel_many.id]] = [[__mm_demo1_rel_many_je.value]] LEFT JOIN "demo2" "__mm_demo1_rel_many_rel" ON [[__mm_demo1_rel_many_rel.id]] = [[__mm_demo1_rel_many.rel]] WHERE "__mm_demo1"."id" = "demo1"."id") {{__mrTEST}} ON 1 = 1 WHERE NOT (to_jsonb([[__mlTEST.multiMatchValue]]) IS NOT DISTINCT FROM to_jsonb([[__mrTEST.multiMatchValue]]))))) AND to_jsonb([[__collection_demo2.active]]) IS NOT DISTINCT FROM to_jsonb([[demo1_rel_many_rel.active]]) AND (([[demo1_rel_many.verified]] > [[__data_users_rel_many.verified]]) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo1_rel_many.verified]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo1.rel_many]] IS JSON OR json_valid([[__mm_demo1.rel_many]]::text)) AND jsonb_typeof([[__mm_demo1.rel_many]]::jsonb) = 'array' THEN [[__mm_demo1.rel_many]]::jsonb ELSE jsonb_build_array([[__mm_demo1.rel_many]]) END) "__mm_demo1_rel_many_je" ON 1=1 LEFT JOIN "users" "__mm_demo1_rel_many" ON [[__mm_demo1_rel_many.id]] = [[__mm_demo1_rel_many_je.value]] WHERE "__mm_demo1"."id" = "demo1"."id") {{__mlTEST}} LEFT JOIN (SELECT [[__mm___data_users_rel_many.verified]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN "users" "__mm___data_users_rel_many" ON [[__mm___data_users_rel_many.id]] IN ({:p2}, {:p3}) WHERE "__mm_demo1"."id" = "demo1"."id") {{__mrTEST}} ON 1 = 1 WHERE NOT ([[__mlTEST.multiMatchValue]] > [[__mrTEST.multiMatchValue]])))))`,
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT "demo1".* FROM "demo1" WHERE (0 > 1 AND 0 > 2 AND 2 < 3 AND 2 > 4 AND 1 = 5 AND 1 = 6 AND 2 IS DISTINCT FROM 7 AND 2 IS DISTINCT FROM 8 AND 1 = 9 AND 1 = 0 AND 3 IS DISTINCT FROM 1 AND 3 IS DISTINCT FROM 2)`,
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo4".* FROM "demo4" LEFT JOIN "demo4" "__data_demo4_self_rel_one" ON [[__data_demo4_self_rel_one.id]]={:p0} LEFT JOIN "demo3" "__data_demo3_rel_many_cascade" ON [[__data_demo3_rel_many_cascade.id]] IN ({:p1}, {:p2}) LEFT JOIN "demo3" "__data_demo3_rel_one_cascade" ON [[__data_demo3_rel_one_cascade.id]]={:p3} LEFT JOIN "demo4" "demo4_self_rel_one" ON [[demo4_self_rel_one.id]] = [[demo4.self_rel_one]] LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[demo4_self_rel_one.rel_many_cascade]] IS JSON OR json_valid([[demo4_self_rel_one.rel_many_cascade]]::text)) AND jsonb_typeof([[demo4_self_rel_one.rel_many_cascade]]::jsonb) = 'array' THEN [[demo4_self_rel_one.rel_many_cascade]]::jsonb ELSE jsonb_build_array([[demo4_self_rel_one.rel_many_cascade]]) END) "__je_demo4_self_rel_one_rel_many_cascade" ON 1=1 LEFT JOIN "demo3" "demo4_self_rel_one_rel_many_cascade" ON [[demo4_self_rel_one_rel_many_cascade.id]] = [[__je_demo4_self_rel_one_rel_many_cascade.value]] WHERE ((CASE WHEN ([[__data_demo4_self_rel_one.self_rel_many]] IS JSON OR JSON_VALID([[__data_demo4_self_rel_one.self_rel_many]]::text)) AND jsonb_typeof([[__data_demo4_self_rel_one.self_rel_many]]::jsonb) = 'array' THEN jsonb_array_length([[__data_demo4_self_rel_one.self_rel_many]]::jsonb) ELSE 0 END) > 1 AND (CASE WHEN ([[__data_demo4_self_rel_one.self_rel_many]] IS JSON OR JSON_VALID([[__data_demo4_self_rel_one.self_rel_many]]::text)) AND jsonb_typeof([[__data_demo4_self_rel_one.self_rel_many]]::jsonb) = 'array' THEN jsonb_array_length([[__data_demo4_self_rel_one.self_rel_many]]::jsonb) ELSE 0 END) > 2 AND (CASE WHEN ([[__data_demo3_rel_many_cascade.files]] IS JSON OR JSON_VALID([[__data_demo3_rel_many_cascade.files]]::text)) AND jsonb_typeof([[__data_demo3_rel_many_cascade.files]]::jsonb) = 'array' THEN jsonb_array_length([[__data_demo3_rel_many_cascade.files]]::jsonb) ELSE 0 END) < 3 AND (((CASE WHEN ([[__data_demo3_rel_many_cascade.files]] IS JSON OR JSON_VALID([[__data_demo3_rel_many_cascade.files]]::text)) AND jsonb_typeof([[__data_demo3_rel_many_cascade.files]]::jsonb) = 'array' THEN jsonb_array_length([[__data_demo3_rel_many_cascade.files]]::jsonb) ELSE 0 END) < 4) AND (NOT EXISTS (SELECT 1 FROM (SELECT (CASE WHEN ([[__mm___data_demo3_rel_many_cascade.files]] IS JSON OR JSON_VALID([[__mm___data_demo3_rel_many_cascade.files]]::text)) AND jsonb_typeof([[__mm___data_demo3_rel_many_cascade.files]]::jsonb) = 'array' THEN jsonb_array_length([[__mm___data_demo3_rel_many_cascade.files]]::jsonb) ELSE 0 END) as [[multiMatchValue]] FROM "demo4" "__mm_demo4" LEFT JOIN "demo3" "__mm___data_demo3_rel_many_cascade" ON [[__mm___data_demo3_rel_many_cascade.id]] IN ({:p4}, {:p5}) WHERE "__mm_demo4"."id" = "demo4"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] < 4)))) AND (CASE WHEN ([[__data_demo3_rel_one_cascade.files]] IS JSON OR JSON_VALID([[__data_demo3_rel_one_cascade.files]]::text)) AND jsonb_typeof([[__data_demo3_rel_one_cascade.files]]::jsonb) = 'array' THEN jsonb_array_length([[__data_demo3_rel_one_cascade.files]]::jsonb) ELSE 0 END) < 4.1 AND (CASE WHEN ([[demo4_self_rel_one.self_rel_many]] IS JSON OR JSON_VALID([[demo4_self_rel_one.self_rel_many]]::text)) AND jsonb_typeof([[demo4_self_rel_one.self_rel_many]]::jsonb) = 'array' THEN jsonb_array_length([[demo4_self_rel_one.self_rel_many]]::jsonb) ELSE 0 END) = 5 AND (CASE WHEN ([[demo4_self_rel_one.self_rel_many]] IS JSON OR JSON_VALID([[demo4_self_rel_one.self_rel_many]]::text)) AND jsonb_typeof([[demo4_self_rel_one.self_rel_many]]::jsonb) = 'array' THEN jsonb_array_length([[demo4_self_rel_one.self_rel_many]]::jsonb) ELSE 0 END) = 6 AND (((CASE WHEN ([[demo4_self_rel_one_rel_many_cascade.files]] IS JSON OR JSON_VALID([[demo4_self_rel_one_rel_many_cascade.files]]::text)) AND jsonb_typeof([[demo4_self_rel_one_rel_many_cascade.files]]::jsonb) = 'array' THEN jsonb_array_length([[demo4_self_rel_one_rel_many_cascade.files]]::jsonb) ELSE 0 END) IS DISTINCT FROM 7) AND (NOT EXISTS (SELECT 1 FROM (SELECT (CASE WHEN ([[__mm_demo4_self_rel_one_rel_many_cascade.files]] IS JSON OR JSON_VALID([[__mm_demo4_self_rel_one_rel_many_cascade.files]]::text)) AND jsonb_typeof([[__mm_demo4_self_rel_one_rel_many_cascade.files]]::jsonb) = 'array' THEN jsonb_array_length([[__mm_demo4_self_rel_one_rel_many_cascade.files]]::jsonb) ELSE 0 END) as [[multiMatchValue]] FROM "demo4" "__mm_demo4" LEFT JOIN "demo4" "__mm_demo4_self_rel_one" ON [[__mm_demo4_self_rel_one.id]] = [[__mm_demo4.self_rel_one]] LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo4_self_rel_one.rel_many_cascade]] IS JSON OR json_valid([[__mm_demo4_self_rel_one.rel_many_cascade]]::text)) AND jsonb_typeof([[__mm_demo4_self_rel_one.rel_many_cascade]]::jsonb) = 'array' THEN [[__mm_demo4_self_rel_one.rel_many_cascade]]::jsonb ELSE jsonb_build_array([[__mm_demo4_self_rel_one.rel_many_cascade]]) END) "__mm_demo4_self_rel_one_rel_many_cascade_je" ON 1=1 LEFT JOIN "demo3" "__mm_demo4_self_rel_one_rel_many_cascade" ON [[__mm_demo4_self_rel_one_rel_many_cascade.id]] = [[__mm_demo4_self_rel_one_rel_many_cascade_je.value]] WHERE "__mm_demo4"."id" = "demo4"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] IS DISTINCT FROM 7)))) AND (CASE WHEN ([[demo4_self_rel_one_rel_many_cascade.files]] IS JSON OR JSON_VALID([[demo4_self_rel_one_rel_many_cascade.files]]::text)) AND jsonb_typeof([[demo4_self_rel_one_rel_many_cascade.files]]::jsonb) = 'array' THEN jsonb_array_length([[demo4_self_rel_one_rel_many_cascade.files]]::jsonb) ELSE 0 END) IS DISTINCT FROM 8)`,
		},
		{
		...
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT "demo1".* FROM "demo1" WHERE ((TRUE = TRUE AND {:TEST} IS DISTINCT FROM [[demo1.number]]) IS NOT DISTINCT FROM FALSE AND (FALSE = TRUE AND ('' IS DISTINCT FROM [[demo1.email]]::text AND [[demo1.email]] IS NOT NULL)) IS NOT DISTINCT FROM TRUE AND (TRUE = TRUE AND {:TEST} IS DISTINCT FROM [[demo1.number]]) IS NOT DISTINCT FROM (TRUE = TRUE AND {:TEST} IS DISTINCT FROM [[demo1.select_many]]))`,
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT "demo4".* FROM "demo4" WHERE (JSON_QUERY_OR_NULL([[demo4.json_object]], '$.a.b')::jsonb IS NOT DISTINCT FROM to_jsonb(''::text) AND (CASE WHEN ([[demo4.self_rel_many]] IS JSON OR JSON_VALID([[demo4.self_rel_many]]::text)) AND jsonb_typeof([[demo4.self_rel_many]]::jsonb) = 'array' THEN jsonb_array_length([[demo4.self_rel_many]]::jsonb) ELSE 0 END) IS DISTINCT FROM 2 AND JSON_QUERY_OR_NULL([[demo4.json_object]], '$.a.b')::jsonb::numeric > 3 AND (CASE WHEN ([[demo4.self_rel_many]] IS JSON OR JSON_VALID([[demo4.self_rel_many]]::text)) AND jsonb_typeof([[demo4.self_rel_many]]::jsonb) = 'array' THEN jsonb_array_length([[demo4.self_rel_many]]::jsonb) ELSE 0 END) <= 4)`,
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo4".* FROM "demo4" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[demo4.self_rel_many]] IS JSON OR json_valid([[demo4.self_rel_many]]::text)) AND jsonb_typeof([[demo4.self_rel_many]]::jsonb) = 'array' THEN [[demo4.self_rel_many]]::jsonb ELSE jsonb_build_array([[demo4.self_rel_many]]) END) "__je_demo4_self_rel_many" ON 1=1 LEFT JOIN "demo4" "demo4_self_rel_many" ON [[demo4_self_rel_many.id]] = [[__je_demo4_self_rel_many.value]] WHERE (JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb IS NOT DISTINCT FROM to_jsonb(''::text) OR JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb IS DISTINCT FROM to_jsonb(''::text) OR to_jsonb(''::text) IS NOT DISTINCT FROM JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb OR to_jsonb(''::text) IS DISTINCT FROM JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb OR JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb IS NOT DISTINCT FROM to_jsonb(NULL::text) OR JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb IS DISTINCT FROM to_jsonb(NULL::text) OR to_jsonb(NULL::text) IS NOT DISTINCT FROM JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb OR to_jsonb(NULL::text) IS DISTINCT FROM JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb OR JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb IS NOT DISTINCT FROM to_jsonb(TRUE) OR JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb IS DISTINCT FROM to_jsonb(TRUE) OR to_jsonb(TRUE) IS NOT DISTINCT FROM JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb OR to_jsonb(TRUE) IS DISTINCT FROM JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb OR JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb IS NOT DISTINCT FROM JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb OR JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb IS DISTINCT FROM JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb OR JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb IS NOT DISTINCT FROM to_jsonb([[demo4.title]]) OR to_jsonb([[demo4.title]]) IS DISTINCT FROM JSON_QUERY_OR_NULL([[demo4.json_object]], '$')::jsonb OR ((JSON_QUERY_OR_NULL([[demo4_self_rel_many.json_object]], '$')::jsonb IS NOT DISTINCT FROM to_jsonb(''::text)) AND (NOT EXISTS (SELECT 1 FROM (SELECT JSON_QUERY_OR_NULL([[__mm_demo4_self_rel_many.json_object]], '$')::jsonb as [[multiMatchValue]] FROM "demo4" "__mm_demo4" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo4.self_rel_many]] IS JSON OR json_valid([[__mm_demo4.self_rel_many]]::text)) AND jsonb_typeof([[__mm_demo4.self_rel_many]]::jsonb) = 'array' THEN [[__mm_demo4.self_rel_many]]::jsonb ELSE jsonb_build_array([[__mm_demo4.self_rel_many]]) END) "__mm_demo4_self_rel_many_je" ON 1=1 LEFT JOIN "demo4" "__mm_demo4_self_rel_many" ON [[__mm_demo4_self_rel_many.id]] = [[__mm_demo4_self_rel_many_je.value]] WHERE "__mm_demo4"."id" = "demo4"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] IS NOT DISTINCT FROM '')))) OR ((to_jsonb(NULL::text) IS NOT DISTINCT FROM JSON_QUERY_OR_NULL([[demo4_self_rel_many.json_object]], '$')::jsonb) AND (NOT EXISTS (SELECT 1 FROM (SELECT JSON_QUERY_OR_NULL([[__mm_demo4_self_rel_many.json_object]], '$')::jsonb as [[multiMatchValue]] FROM "demo4" "__mm_demo4" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo4.self_rel_many]] IS JSON OR json_valid([[__mm_demo4.self_rel_many]]::text)) AND jsonb_typeof([[__mm_demo4.self_rel_many]]::jsonb) = 'array' THEN [[__mm_demo4.self_rel_many]]::jsonb ELSE jsonb_build_array([[__mm_demo4.self_rel_many]]) END) "__mm_demo4_self_rel_many_je" ON 1=1 LEFT JOIN "demo4" "__mm_demo4_self_rel_many" ON [[__mm_demo4_self_rel_many.id]] = [[__mm_demo4_self_rel_many_je.value]] WHERE "__mm_demo4"."id" = "demo4"."id") {{__smTEST}} WHERE NOT (NULL IS NOT DISTINCT FROM [[__smTEST.multiMatchValue]])))) OR ((JSON_QUERY_OR_NULL([[demo4_self_rel_many.json_object]], '$')::jsonb IS NOT DISTINCT FROM JSON_QUERY_OR_NULL([[demo4_self_rel_many.json_object]], '$')::jsonb) AND (NOT EXISTS (SELECT 1 FROM (SELECT JSON_QUERY_OR_NULL([[__mm_demo4_self_rel_many.json_object]], '$')::jsonb as [[multiMatchValue]] FROM "demo4" "__mm_demo4" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo4.self_rel_many]] IS JSON OR json_valid([[__mm_demo4.self_rel_many]]::text)) AND jsonb_typeof([[__mm_demo4.self_rel_many]]::jsonb) = 'array' THEN [[__mm_demo4.self_rel_many]]::jsonb ELSE jsonb_build_array([[__mm_demo4.self_rel_many]]) END) "__mm_demo4_self_rel_many_je" ON 1=1 LEFT JOIN "demo4" "__mm_demo4_self_rel_many" ON [[__mm_demo4_self_rel_many.id]] = [[__mm_demo4_self_rel_many_je.value]] WHERE "__mm_demo4"."id" = "demo4"."id") {{__mlTEST}} LEFT JOIN (SELECT JSON_QUERY_OR_NULL([[__mm_demo4_self_rel_many.json_object]], '$')::jsonb as [[multiMatchValue]] FROM "demo4" "__mm_demo4" LEFT JOIN jsonb_array_elements_text(CASE WHEN ([[__mm_demo4.self_rel_many]] IS JSON OR json_valid([[__mm_demo4.self_rel_many]]::text)) AND jsonb_typeof([[__mm_demo4.self_rel_many]]::jsonb) = 'array' THEN [[__mm_demo4.self_rel_many]]::jsonb ELSE jsonb_build_array([[__mm_demo4.self_rel_many]]) END) "__mm_demo4_self_rel_many_je" ON 1=1 LEFT JOIN "demo4" "__mm_demo4_self_rel_many" ON [[__mm_demo4_self_rel_many.id]] = [[__mm_demo4_self_rel_many_je.value]] WHERE "__mm_demo4"."id" = "demo4"."id") {{__mrTEST}} ON 1 = 1 WHERE NOT ([[__mlTEST.multiMatchValue]] IS NOT DISTINCT FROM [[__mrTEST.multiMatchValue]])))))`,
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT "view1".* FROM "view1" WHERE (([[view1.point]]::text = '' OR [[view1.point]] IS NULL) OR JSON_QUERY_OR_NULL([[view1.point]], '$.lat')::jsonb::numeric > 1 OR JSON_QUERY_OR_NULL([[view1.point]], '$.lon')::jsonb::numeric < 2 OR JSON_QUERY_OR_NULL([[view1.point]], '$.something')::jsonb::numeric > 3)`,
		},
	}
