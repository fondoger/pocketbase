...
func TestRecordFieldResolverUpdateQuery(t *testing.T) {
	...
	scenarios := []struct {
		...
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo4".* FROM "demo4" LEFT JOIN json_array_elements_text(CASE WHEN [[demo4.self_rel_many]] IS JSON OR json_valid([[demo4.self_rel_many]]::text) THEN [[demo4.self_rel_many]]::json ELSE json_array([[demo4.self_rel_many]]) END) "demo4_self_rel_many_je" LEFT JOIN "demo4" "demo4_self_rel_many" ON [[demo4_self_rel_many.id]] = [[demo4_self_rel_many_je.value]] WHERE [[demo4_self_rel_many.id]]::numeric > TRUE::numeric`,
		},
		{
		...
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo4".* FROM "demo4" LEFT JOIN json_array_elements_text(CASE WHEN [[demo4.self_rel_many]] IS JSON OR json_valid([[demo4.self_rel_many]]::text) THEN [[demo4.self_rel_many]]::json ELSE json_array([[demo4.self_rel_many]]) END) "demo4_self_rel_many_je" LEFT JOIN "demo4" "demo4_self_rel_many" ON [[demo4_self_rel_many.id]] = [[demo4_self_rel_many_je.value]] WHERE ((([[demo4_self_rel_many.self_rel_one]]::numeric > TRUE::numeric) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo4_self_rel_many.self_rel_one]] as [[multiMatchValue]] FROM "demo4" "__mm_demo4" LEFT JOIN json_array_elements_text(CASE WHEN [[__mm_demo4.self_rel_many]] IS JSON OR json_valid([[__mm_demo4.self_rel_many]]::text) THEN [[__mm_demo4.self_rel_many]]::json ELSE json_array([[__mm_demo4.self_rel_many]]) END) "__mm_demo4_self_rel_many_je" LEFT JOIN "demo4" "__mm_demo4_self_rel_many" ON [[__mm_demo4_self_rel_many.id]] = [[__mm_demo4_self_rel_many_je.value]] WHERE "__mm_demo4"."id" = "demo4"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]]::numeric > TRUE::numeric)))))`,
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo4".* FROM "demo4" LEFT JOIN json_array_elements_text(CASE WHEN [[demo4.self_rel_many]] IS JSON OR json_valid([[demo4.self_rel_many]]::text) THEN [[demo4.self_rel_many]]::json ELSE json_array([[demo4.self_rel_many]]) END) "demo4_self_rel_many_je" LEFT JOIN "demo4" "demo4_self_rel_many" ON [[demo4_self_rel_many.id]] = [[demo4_self_rel_many_je.value]] LEFT JOIN "demo4" "demo4_self_rel_many_self_rel_one" ON [[demo4_self_rel_many_self_rel_one.id]] = [[demo4_self_rel_many.self_rel_one]] WHERE [[demo4_self_rel_many_self_rel_one.title]]::numeric > TRUE::numeric`,
		},
		{
		...
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo4".* FROM "demo4" LEFT JOIN json_array_elements_text(CASE WHEN [[demo4.self_rel_many]] IS JSON OR json_valid([[demo4.self_rel_many]]::text) THEN [[demo4.self_rel_many]]::json ELSE json_array([[demo4.self_rel_many]]) END) "demo4_self_rel_many_je" LEFT JOIN "demo4" "demo4_self_rel_many" ON [[demo4_self_rel_many.id]] = [[demo4_self_rel_many_je.value]] LEFT JOIN "demo4" "demo4_self_rel_many_self_rel_one" ON [[demo4_self_rel_many_self_rel_one.id]] = [[demo4_self_rel_many.self_rel_one]] LEFT JOIN json_array_elements_text(CASE WHEN [[demo4_self_rel_many_self_rel_one.self_rel_many]] IS JSON OR json_valid([[demo4_self_rel_many_self_rel_one.self_rel_many]]::text) THEN [[demo4_self_rel_many_self_rel_one.self_rel_many]]::json ELSE json_array([[demo4_self_rel_many_self_rel_one.self_rel_many]]) END) "demo4_self_rel_many_self_rel_one_self_rel_many_je" LEFT JOIN "demo4" "demo4_self_rel_many_self_rel_one_self_rel_many" ON [[demo4_self_rel_many_self_rel_one_self_rel_many.id]] = [[demo4_self_rel_many_self_rel_one_self_rel_many_je.value]] LEFT JOIN "demo4" "demo4_self_rel_many_self_rel_one_self_rel_many_self_rel_one" ON [[demo4_self_rel_many_self_rel_one_self_rel_many_self_rel_one.id]] = [[demo4_self_rel_many_self_rel_one_self_rel_many.self_rel_one]] WHERE [[demo4_self_rel_many_self_rel_one_self_rel_many_self_rel_one.title]]::numeric > TRUE::numeric`,
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo4".* FROM "demo4" LEFT JOIN json_array_elements_text(CASE WHEN [[demo4.self_rel_many]] IS JSON OR json_valid([[demo4.self_rel_many]]::text) THEN [[demo4.self_rel_many]]::json ELSE json_array([[demo4.self_rel_many]]) END) "demo4_self_rel_many_je" LEFT JOIN "demo4" "demo4_self_rel_many" ON [[demo4_self_rel_many.id]] = [[demo4_self_rel_many_je.value]] LEFT JOIN "demo4" "demo4_self_rel_many_self_rel_one" ON [[demo4_self_rel_many_self_rel_one.id]] = [[demo4_self_rel_many.self_rel_one]] LEFT JOIN json_array_elements_text(CASE WHEN [[demo4_self_rel_many_self_rel_one.self_rel_many]] IS JSON OR json_valid([[demo4_self_rel_many_self_rel_one.self_rel_many]]::text) THEN [[demo4_self_rel_many_self_rel_one.self_rel_many]]::json ELSE json_array([[demo4_self_rel_many_self_rel_one.self_rel_many]]) END) "demo4_self_rel_many_self_rel_one_self_rel_many_je" LEFT JOIN "demo4" "demo4_self_rel_many_self_rel_one_self_rel_many" ON [[demo4_self_rel_many_self_rel_one_self_rel_many.id]] = [[demo4_self_rel_many_self_rel_one_self_rel_many_je.value]] LEFT JOIN "demo4" "demo4_self_rel_many_self_rel_one_self_rel_many_self_rel_one" ON [[demo4_self_rel_many_self_rel_one_self_rel_many_self_rel_one.id]] = [[demo4_self_rel_many_self_rel_one_self_rel_many.self_rel_one]] WHERE ((([[demo4_self_rel_many_self_rel_one_self_rel_many_self_rel_one.title]]::numeric > TRUE::numeric) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo4_self_rel_many_self_rel_one_self_rel_many_self_rel_one.title]] as [[multiMatchValue]] FROM "demo4" "__mm_demo4" LEFT JOIN json_array_elements_text(CASE WHEN [[__mm_demo4.self_rel_many]] IS JSON OR json_valid([[__mm_demo4.self_rel_many]]::text) THEN [[__mm_demo4.self_rel_many]]::json ELSE json_array([[__mm_demo4.self_rel_many]]) END) "__mm_demo4_self_rel_many_je" LEFT JOIN "demo4" "__mm_demo4_self_rel_many" ON [[__mm_demo4_self_rel_many.id]] = [[__mm_demo4_self_rel_many_je.value]] LEFT JOIN "demo4" "__mm_demo4_self_rel_many_self_rel_one" ON [[__mm_demo4_self_rel_many_self_rel_one.id]] = [[__mm_demo4_self_rel_many.self_rel_one]] LEFT JOIN json_array_elements_text(CASE WHEN [[__mm_demo4_self_rel_many_self_rel_one.self_rel_many]] IS JSON OR json_valid([[__mm_demo4_self_rel_many_self_rel_one.self_rel_many]]::text) THEN [[__mm_demo4_self_rel_many_self_rel_one.self_rel_many]]::json ELSE json_array([[__mm_demo4_self_rel_many_self_rel_one.self_rel_many]]) END) "__mm_demo4_self_rel_many_self_rel_one_self_rel_many_je" LEFT JOIN "demo4" "__mm_demo4_self_rel_many_self_rel_one_self_rel_many" ON [[__mm_demo4_self_rel_many_self_rel_one_self_rel_many.id]] = [[__mm_demo4_self_rel_many_self_rel_one_self_rel_many_je.value]] LEFT JOIN "demo4" "__mm_demo4_self_rel_many_self_rel_one_self_rel_many_self_rel_one" ON [[__mm_demo4_self_rel_many_self_rel_one_self_rel_many_self_rel_one.id]] = [[__mm_demo4_self_rel_many_self_rel_one_self_rel_many.self_rel_one]] WHERE "__mm_demo4"."id" = "demo4"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]]::numeric > TRUE::numeric)))))`,
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo4".* FROM "demo4" LEFT JOIN json_array_elements_text(CASE WHEN [[demo4.self_rel_many]] IS JSON OR json_valid([[demo4.self_rel_many]]::text) THEN [[demo4.self_rel_many]]::json ELSE json_array([[demo4.self_rel_many]]) END) "demo4_self_rel_many_je" LEFT JOIN "demo4" "demo4_self_rel_many" ON [[demo4_self_rel_many.id]] = [[demo4_self_rel_many_je.value]] LEFT JOIN "demo4" "demo4_self_rel_one" ON [[demo4_self_rel_one.id]] = [[demo4.self_rel_one]] WHERE ([[demo4_self_rel_many.title]] = {:TEST} OR ((CASE WHEN [[demo4_self_rel_one.json_object]] IS JSON OR json_valid([[demo4_self_rel_one.json_object]]::text) THEN JSON_QUERY([[demo4_self_rel_one.json_object]]::json, '$.a') ELSE NULL END) #>> '{}')::text::numeric > TRUE::numeric)`,
		},
		{
		...
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo3".* FROM "demo3" LEFT JOIN "demo4" "demo3_demo4_via_rel_one_cascade" ON [[demo3.id]] IN (SELECT [[demo3_demo4_via_rel_one_cascade_je.value]] FROM json_array_elements_text(CASE WHEN [[demo3_demo4_via_rel_one_cascade.rel_one_cascade]] IS JSON OR json_valid([[demo3_demo4_via_rel_one_cascade.rel_one_cascade]]::text) THEN [[demo3_demo4_via_rel_one_cascade.rel_one_cascade]]::json ELSE json_array([[demo3_demo4_via_rel_one_cascade.rel_one_cascade]]) END) {{demo3_demo4_via_rel_one_cascade_je}}) WHERE ((([[demo3_demo4_via_rel_one_cascade.id]] = TRUE) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo3_demo4_via_rel_one_cascade.id]] as [[multiMatchValue]] FROM "demo3" "__mm_demo3" LEFT JOIN "demo4" "__mm_demo3_demo4_via_rel_one_cascade" ON [[__mm_demo3.id]] IN (SELECT [[__mm_demo3_demo4_via_rel_one_cascade_je.value]] FROM json_array_elements_text(CASE WHEN [[__mm_demo3_demo4_via_rel_one_cascade.rel_one_cascade]] IS JSON OR json_valid([[__mm_demo3_demo4_via_rel_one_cascade.rel_one_cascade]]::text) THEN [[__mm_demo3_demo4_via_rel_one_cascade.rel_one_cascade]]::json ELSE json_array([[__mm_demo3_demo4_via_rel_one_cascade.rel_one_cascade]]) END) {{__mm_demo3_demo4_via_rel_one_cascade_je}}) WHERE "__mm_demo3"."id" = "demo3"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] = TRUE)))))`,
		},
		{
		...
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo3".* FROM "demo3" LEFT JOIN "demo4" "demo3_demo4_via_rel_many_cascade" ON [[demo3.id]] IN (SELECT [[demo3_demo4_via_rel_many_cascade_je.value]] FROM json_array_elements_text(CASE WHEN [[demo3_demo4_via_rel_many_cascade.rel_many_cascade]] IS JSON OR json_valid([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]::text) THEN [[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]::json ELSE json_array([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]) END) {{demo3_demo4_via_rel_many_cascade_je}}) WHERE [[demo3_demo4_via_rel_many_cascade.id]] = TRUE`,
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo3".* FROM "demo3" LEFT JOIN "demo4" "demo3_demo4_via_rel_many_cascade" ON [[demo3.id]] IN (SELECT [[demo3_demo4_via_rel_many_cascade_je.value]] FROM json_array_elements_text(CASE WHEN [[demo3_demo4_via_rel_many_cascade.rel_many_cascade]] IS JSON OR json_valid([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]::text) THEN [[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]::json ELSE json_array([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]) END) {{demo3_demo4_via_rel_many_cascade_je}}) WHERE ((([[demo3_demo4_via_rel_many_cascade.id]] = TRUE) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo3_demo4_via_rel_many_cascade.id]] as [[multiMatchValue]] FROM "demo3" "__mm_demo3" LEFT JOIN "demo4" "__mm_demo3_demo4_via_rel_many_cascade" ON [[__mm_demo3.id]] IN (SELECT [[__mm_demo3_demo4_via_rel_many_cascade_je.value]] FROM json_array_elements_text(CASE WHEN [[__mm_demo3_demo4_via_rel_many_cascade.rel_many_cascade]] IS JSON OR json_valid([[__mm_demo3_demo4_via_rel_many_cascade.rel_many_cascade]]::text) THEN [[__mm_demo3_demo4_via_rel_many_cascade.rel_many_cascade]]::json ELSE json_array([[__mm_demo3_demo4_via_rel_many_cascade.rel_many_cascade]]) END) {{__mm_demo3_demo4_via_rel_many_cascade_je}}) WHERE "__mm_demo3"."id" = "demo3"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] = TRUE)))))`,
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo3".* FROM "demo3" LEFT JOIN "demo4" "demo3_demo4_via_rel_many_unique" ON [[demo3.id]] IN (SELECT [[demo3_demo4_via_rel_many_unique_je.value]] FROM json_array_elements_text(CASE WHEN [[demo3_demo4_via_rel_many_unique.rel_many_unique]] IS JSON OR json_valid([[demo3_demo4_via_rel_many_unique.rel_many_unique]]::text) THEN [[demo3_demo4_via_rel_many_unique.rel_many_unique]]::json ELSE json_array([[demo3_demo4_via_rel_many_unique.rel_many_unique]]) END) {{demo3_demo4_via_rel_many_unique_je}}) WHERE ((([[demo3_demo4_via_rel_many_unique.id]] = TRUE) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo3_demo4_via_rel_many_unique.id]] as [[multiMatchValue]] FROM "demo3" "__mm_demo3" LEFT JOIN "demo4" "__mm_demo3_demo4_via_rel_many_unique" ON [[__mm_demo3.id]] IN (SELECT [[__mm_demo3_demo4_via_rel_many_unique_je.value]] FROM json_array_elements_text(CASE WHEN [[__mm_demo3_demo4_via_rel_many_unique.rel_many_unique]] IS JSON OR json_valid([[__mm_demo3_demo4_via_rel_many_unique.rel_many_unique]]::text) THEN [[__mm_demo3_demo4_via_rel_many_unique.rel_many_unique]]::json ELSE json_array([[__mm_demo3_demo4_via_rel_many_unique.rel_many_unique]]) END) {{__mm_demo3_demo4_via_rel_many_unique_je}}) WHERE "__mm_demo3"."id" = "demo3"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] = TRUE)))))`,
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo3".* FROM "demo3" LEFT JOIN "demo4" "demo3_demo4_via_rel_many_cascade" ON [[demo3.id]] IN (SELECT [[demo3_demo4_via_rel_many_cascade_je.value]] FROM json_array_elements_text(CASE WHEN [[demo3_demo4_via_rel_many_cascade.rel_many_cascade]] IS JSON OR json_valid([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]::text) THEN [[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]::json ELSE json_array([[demo3_demo4_via_rel_many_cascade.rel_many_cascade]]) END) {{demo3_demo4_via_rel_many_cascade_je}}) LEFT JOIN "demo3" "demo3_demo4_via_rel_many_cascade_rel_one_cascade" ON [[demo3_demo4_via_rel_many_cascade_rel_one_cascade.id]] = [[demo3_demo4_via_rel_many_cascade.rel_one_cascade]] LEFT JOIN "demo4" "demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade" ON [[demo3_demo4_via_rel_many_cascade_rel_one_cascade.id]] IN (SELECT [[demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade_je.value]] FROM json_array_elements_text(CASE WHEN [[demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade.rel_many_cascade]] IS JSON OR json_valid([[demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade.rel_many_cascade]]::text) THEN [[demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade.rel_many_cascade]]::json ELSE json_array([[demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade.rel_many_cascade]]) END) {{demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade_je}}) WHERE [[demo3_demo4_via_rel_many_cascade_rel_one_cascade_demo4_via_rel_many_cascade.id]] = TRUE`,
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo4".* FROM "demo4" LEFT JOIN "demo1" "__collection_demo1" LEFT JOIN "demo2" "__collection_demo2" LEFT JOIN "demo1" "__collection_alias_demo1_alias" WHERE ([[__collection_demo1.text]]::numeric > TRUE::numeric OR [[__collection_demo2.active]]::numeric > TRUE::numeric OR [[__collection_alias_demo1_alias.file_one]]::numeric > TRUE::numeric)`,
		},
		{
		...
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo1".* FROM "demo1" LEFT JOIN "users" "__data_users_rel_many" ON [[__data_users_rel_many.id]] IN ({:p0}, {:p1}) LEFT JOIN json_array_elements_text(CASE WHEN [[demo1.rel_many]] IS JSON OR json_valid([[demo1.rel_many]]::text) THEN [[demo1.rel_many]]::json ELSE json_array([[demo1.rel_many]]) END) "demo1_rel_many_je" LEFT JOIN "users" "demo1_rel_many" ON [[demo1_rel_many.id]] = [[demo1_rel_many_je.value]] WHERE (LOWER({:infoLowerrel_oneTEST})::numeric > TRUE::numeric OR LOWER({:infoLowerrel_manyTEST})::numeric > TRUE::numeric OR ((LOWER([[__data_users_rel_many.email]])::numeric > TRUE::numeric) AND (NOT EXISTS (SELECT 1 FROM (SELECT LOWER([[__data_mm_users_rel_many.email]]) as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN "users" "__data_mm_users_rel_many" ON [[__data_mm_users_rel_many.id]] IN ({:p4}, {:p5}) WHERE "__mm_demo1"."id" = "demo1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]]::numeric > TRUE::numeric)))) OR LOWER([[demo1.text]])::numeric > TRUE::numeric OR LOWER([[demo1.bool]])::numeric > TRUE::numeric OR LOWER([[demo1.url]])::numeric > TRUE::numeric OR LOWER([[demo1.select_one]])::numeric > TRUE::numeric OR LOWER([[demo1.select_many]])::numeric > TRUE::numeric OR LOWER([[demo1.file_one]])::numeric > TRUE::numeric OR LOWER([[demo1.file_many]])::numeric > TRUE::numeric OR LOWER([[demo1.number]])::numeric > TRUE::numeric OR LOWER([[demo1.email]])::numeric > TRUE::numeric OR LOWER([[demo1.datetime]])::numeric > TRUE::numeric OR LOWER(((CASE WHEN [[demo1.json]] IS JSON OR json_valid([[demo1.json]]::text) THEN JSON_QUERY([[demo1.json]]::json, '$') ELSE NULL END) #>> '{}')::text)::numeric > TRUE::numeric OR LOWER([[demo1.rel_one]])::numeric > TRUE::numeric OR LOWER([[demo1.rel_many]])::numeric > TRUE::numeric OR ((LOWER([[demo1_rel_many.name]])::numeric > TRUE::numeric) AND (NOT EXISTS (SELECT 1 FROM (SELECT LOWER([[__mm_demo1_rel_many.name]]) as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN json_array_elements_text(CASE WHEN [[__mm_demo1.rel_many]] IS JSON OR json_valid([[__mm_demo1.rel_many]]::text) THEN [[__mm_demo1.rel_many]]::json ELSE json_array([[__mm_demo1.rel_many]]) END) "__mm_demo1_rel_many_je" LEFT JOIN "users" "__mm_demo1_rel_many" ON [[__mm_demo1_rel_many.id]] = [[__mm_demo1_rel_many_je.value]] WHERE "__mm_demo1"."id" = "demo1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]]::numeric > TRUE::numeric)))) OR LOWER([[demo1.created]])::numeric > TRUE::numeric)`,
		},
		{
			"isset modifier",
			"demo1",
		...
		},
		{
			...
			*/
			// PostgreSQL:
			`TEST TEST "demo1".* FROM "demo1" LEFT JOIN TEST({:dataETEST}) "__dataEach_seleTEST" LEFT JOIN TEST({:dataETEST}) "__dataEach_selecTEST" LEFT JOIN TEST({:dataETEST}) "__dataEach_fiTEST" LEFT JOIN TEST({:dataETEST}) "__dataEach_filTEST" LEFT JOIN TEST({:dataETEST}) "__dataEach_rTEST" LEFT JOIN TEST({:dataETEST}) "__dataEach_reTEST" WHERE ([[__dataEach_seleTEST.value]]::nTEST > TRUE::nTEST AND [[__dataEach_seleTEST.value]]::nTEST < TRUE::nTEST AND (([[__dataEach_selecTEST.value]]::nTEST > TRUE::nTEST) AND (NOT TEST (TEST 1 FROM (TEST [[__mm__dataEach_selecTEST.value]] as [[multiMTEST]] FROM "demo1" "_TEST" LEFT JOIN TEST({:mmdataETEST}) "__mm__dataEach_selecTEST" WHERE "_TEST"."id" = "demo1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMTEST]]::nTEST > TRUE::nTEST)))) AND [[__dataEach_selecTEST.value]]::nTEST < TRUE::nTEST AND [[__dataEach_fiTEST.value]]::nTEST > TRUE::nTEST AND [[__dataEach_fiTEST.value]]::nTEST < TRUE::nTEST AND (([[__dataEach_filTEST.value]]::nTEST > TRUE::nTEST) AND (NOT TEST (TEST 1 FROM (TEST [[__mm__dataEach_filTEST.value]] as [[multiMTEST]] FROM "demo1" "_TEST" LEFT JOIN TEST({:mmdataETEST}) "__mm__dataEach_filTEST" WHERE "_TEST"."id" = "demo1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMTEST]]::nTEST > TRUE::nTEST)))) AND [[__dataEach_filTEST.value]]::nTEST < TRUE::nTEST AND [[__dataEach_rTEST.value]]::nTEST > TRUE::nTEST AND [[__dataEach_rTEST.value]]::nTEST < TRUE::nTEST AND (([[__dataEach_reTEST.value]]::nTEST > TRUE::nTEST) AND (NOT TEST (TEST 1 FROM (TEST [[__mm__dataEach_reTEST.value]] as [[multiMTEST]] FROM "demo1" "_TEST" LEFT JOIN TEST({:mmdataETEST}) "__mm__dataEach_reTEST" WHERE "_TEST"."id" = "demo1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMTEST]]::nTEST > TRUE::nTEST)))) AND [[__dataEach_reTEST.value]]::nTEST < TRUE::nTEST)`,
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo1".* FROM "demo1" LEFT JOIN json_array_elements_text(CASE WHEN [[demo1.select_one]] IS JSON OR json_valid([[demo1.select_one]]::text) THEN [[demo1.select_one]]::json ELSE json_array([[demo1.select_one]]) END) "demo1_select_one_je" LEFT JOIN json_array_elements_text(CASE WHEN [[demo1.select_many]] IS JSON OR json_valid([[demo1.select_many]]::text) THEN [[demo1.select_many]]::json ELSE json_array([[demo1.select_many]]) END) "demo1_select_many_je" LEFT JOIN json_array_elements_text(CASE WHEN [[demo1.file_one]] IS JSON OR json_valid([[demo1.file_one]]::text) THEN [[demo1.file_one]]::json ELSE json_array([[demo1.file_one]]) END) "demo1_file_one_je" LEFT JOIN json_array_elements_text(CASE WHEN [[demo1.file_many]] IS JSON OR json_valid([[demo1.file_many]]::text) THEN [[demo1.file_many]]::json ELSE json_array([[demo1.file_many]]) END) "demo1_file_many_je" LEFT JOIN json_array_elements_text(CASE WHEN [[demo1.rel_one]] IS JSON OR json_valid([[demo1.rel_one]]::text) THEN [[demo1.rel_one]]::json ELSE json_array([[demo1.rel_one]]) END) "demo1_rel_one_je" LEFT JOIN json_array_elements_text(CASE WHEN [[demo1.rel_many]] IS JSON OR json_valid([[demo1.rel_many]]::text) THEN [[demo1.rel_many]]::json ELSE json_array([[demo1.rel_many]]) END) "demo1_rel_many_je" WHERE ([[demo1_select_one_je.value]]::numeric > TRUE::numeric AND [[demo1_select_one_je.value]]::numeric < TRUE::numeric AND (([[demo1_select_many_je.value]]::numeric > TRUE::numeric) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo1_select_many_je.value]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN json_array_elements_text(CASE WHEN [[__mm_demo1.select_many]] IS JSON OR json_valid([[__mm_demo1.select_many]]::text) THEN [[__mm_demo1.select_many]]::json ELSE json_array([[__mm_demo1.select_many]]) END) "__mm_demo1_select_many_je" WHERE "__mm_demo1"."id" = "demo1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]]::numeric > TRUE::numeric)))) AND [[demo1_select_many_je.value]]::numeric < TRUE::numeric AND [[demo1_file_one_je.value]]::numeric > TRUE::numeric AND [[demo1_file_one_je.value]]::numeric < TRUE::numeric AND (([[demo1_file_many_je.value]]::numeric > TRUE::numeric) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo1_file_many_je.value]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN json_array_elements_text(CASE WHEN [[__mm_demo1.file_many]] IS JSON OR json_valid([[__mm_demo1.file_many]]::text) THEN [[__mm_demo1.file_many]]::json ELSE json_array([[__mm_demo1.file_many]]) END) "__mm_demo1_file_many_je" WHERE "__mm_demo1"."id" = "demo1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]]::numeric > TRUE::numeric)))) AND [[demo1_file_many_je.value]]::numeric < TRUE::numeric AND [[demo1_rel_one_je.value]]::numeric > TRUE::numeric AND [[demo1_rel_one_je.value]]::numeric < TRUE::numeric AND (([[demo1_rel_many_je.value]]::numeric > TRUE::numeric) AND (NOT EXISTS (SELECT 1 FROM (SELECT [[__mm_demo1_rel_many_je.value]] as [[multiMatchValue]] FROM "demo1" "__mm_demo1" LEFT JOIN json_array_elements_text(CASE WHEN [[__mm_demo1.rel_many]] IS JSON OR json_valid([[__mm_demo1.rel_many]]::text) THEN [[__mm_demo1.rel_many]]::json ELSE json_array([[__mm_demo1.rel_many]]) END) "__mm_demo1_rel_many_je" WHERE "__mm_demo1"."id" = "demo1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]]::numeric > TRUE::numeric)))) AND [[demo1_rel_many_je.value]]::numeric < TRUE::numeric)`,
		},
		{
			...
			*/
			// PostgreSQL:
			`TEST TEST "demo1".* FROM "demo1" LEFT JOIN json_array_elemTEST(CASE WHEN [[demo1.sTEST]] IS JSON OR jTEST([[demo1.sTEST]]::text) THEN [[demo1.sTEST]]::json ELSE jTEST([[demo1.sTEST]]) END) "demo1_seleTEST" LEFT JOIN json_array_elemTEST(CASE WHEN [[demo1.seTEST]] IS JSON OR jTEST([[demo1.seTEST]]::text) THEN [[demo1.seTEST]]::json ELSE jTEST([[demo1.seTEST]]) END) "demo1_selecTEST" LEFT JOIN TEST({:dataETEST}) "__dataEach_selecTEST" WHERE ((([[demo1_seleTEST.value]] IS TEST FROM [[demo1_selecTEST.value]]) AND (NOT TEST (TEST 1 FROM (TEST [[__mm_demo1_selecTEST.value]] as [[multiMTEST]] FROM "demo1" "_TEST" LEFT JOIN json_array_elemTEST(CASE WHEN [[_TEST.seTEST]] IS JSON OR jTEST([[_TEST.seTEST]]::text) THEN [[_TEST.seTEST]]::json ELSE jTEST([[_TEST.seTEST]]) END) "__mm_demo1_selecTEST" WHERE "_TEST"."id" = "demo1"."id") {{__smTEST}} WHERE NOT ([[demo1_seleTEST.value]] IS TEST FROM [[__smTEST.multiMTEST]])))) AND (([[demo1_selecTEST.value]]::nTEST > [[demo1_seleTEST.value]]::nTEST) AND (NOT TEST (TEST 1 FROM (TEST [[__mm_demo1_selecTEST.value]] as [[multiMTEST]] FROM "demo1" "_TEST" LEFT JOIN json_array_elemTEST(CASE WHEN [[_TEST.seTEST]] IS JSON OR jTEST([[_TEST.seTEST]]::text) THEN [[_TEST.seTEST]]::json ELSE jTEST([[_TEST.seTEST]]) END) "__mm_demo1_selecTEST" WHERE "_TEST"."id" = "demo1"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMTEST]]::nTEST > [[demo1_seleTEST.value]]::nTEST)))) AND [[demo1_selecTEST.value]]::nTEST < [[demo1_seleTEST.value]]::nTEST AND (([[demo1_selecTEST.value]] = [[__dataEach_selecTEST.value]]) AND (NOT TEST (TEST 1 FROM (TEST [[__mm_demo1_selecTEST.value]] as [[multiMTEST]] FROM "demo1" "_TEST" LEFT JOIN json_array_elemTEST(CASE WHEN [[_TEST.seTEST]] IS JSON OR jTEST([[_TEST.seTEST]]::text) THEN [[_TEST.seTEST]]::json ELSE jTEST([[_TEST.seTEST]]) END) "__mm_demo1_selecTEST" WHERE "_TEST"."id" = "demo1"."id") {{__mlTEST}} LEFT JOIN (TEST [[__mm__dataEach_selecTEST.value]] as [[multiMTEST]] FROM "demo1" "_TEST" LEFT JOIN TEST({:mmdataETEST}) "__mm__dataEach_selecTEST" WHERE "_TEST"."id" = "demo1"."id") {{__mrTEST}} WHERE NOT ([[__mlTEST.multiMTEST]] IS NOT TEST FROM [[__mrTEST.multiMTEST]])))))`,
		},
		{
		...
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo4".* FROM "demo4" LEFT JOIN "demo4" "__data_demo4_self_rel_one" ON [[__data_demo4_self_rel_one.id]]={:p0} LEFT JOIN "demo3" "__data_demo3_rel_many_cascade" ON [[__data_demo3_rel_many_cascade.id]] IN ({:p1}, {:p2}) LEFT JOIN "demo3" "__data_demo3_rel_one_cascade" ON [[__data_demo3_rel_one_cascade.id]]={:p3} LEFT JOIN "demo4" "demo4_self_rel_one" ON [[demo4_self_rel_one.id]] = [[demo4.self_rel_one]] LEFT JOIN json_array_elements_text(CASE WHEN [[demo4_self_rel_one.rel_many_cascade]] IS JSON OR json_valid([[demo4_self_rel_one.rel_many_cascade]]::text) THEN [[demo4_self_rel_one.rel_many_cascade]]::json ELSE json_array([[demo4_self_rel_one.rel_many_cascade]]) END) "demo4_self_rel_one_rel_many_cascade_je" LEFT JOIN "demo3" "demo4_self_rel_one_rel_many_cascade" ON [[demo4_self_rel_one_rel_many_cascade.id]] = [[demo4_self_rel_one_rel_many_cascade_je.value]] WHERE ((CASE WHEN ([[__data_demo4_self_rel_one.self_rel_many]] IS JSON OR JSON_VALID([[__data_demo4_self_rel_one.self_rel_many]]::text)) AND json_typeof([[__data_demo4_self_rel_one.self_rel_many]]::json) = 'array' THEN JSON_ARRAY_LENGTH([[__data_demo4_self_rel_one.self_rel_many]]::json) ELSE 0 END)::numeric > {:TEST}::numeric AND (CASE WHEN ([[__data_demo4_self_rel_one.self_rel_many]] IS JSON OR JSON_VALID([[__data_demo4_self_rel_one.self_rel_many]]::text)) AND json_typeof([[__data_demo4_self_rel_one.self_rel_many]]::json) = 'array' THEN JSON_ARRAY_LENGTH([[__data_demo4_self_rel_one.self_rel_many]]::json) ELSE 0 END)::numeric > {:TEST}::numeric AND (CASE WHEN ([[__data_demo3_rel_many_cascade.files]] IS JSON OR JSON_VALID([[__data_demo3_rel_many_cascade.files]]::text)) AND json_typeof([[__data_demo3_rel_many_cascade.files]]::json) = 'array' THEN JSON_ARRAY_LENGTH([[__data_demo3_rel_many_cascade.files]]::json) ELSE 0 END)::numeric < {:TEST}::numeric AND (((CASE WHEN ([[__data_demo3_rel_many_cascade.files]] IS JSON OR JSON_VALID([[__data_demo3_rel_many_cascade.files]]::text)) AND json_typeof([[__data_demo3_rel_many_cascade.files]]::json) = 'array' THEN JSON_ARRAY_LENGTH([[__data_demo3_rel_many_cascade.files]]::json) ELSE 0 END)::numeric < {:TEST}::numeric) AND (NOT EXISTS (SELECT 1 FROM (SELECT (CASE WHEN ([[__data_mm_demo3_rel_many_cascade.files]] IS JSON OR JSON_VALID([[__data_mm_demo3_rel_many_cascade.files]]::text)) AND json_typeof([[__data_mm_demo3_rel_many_cascade.files]]::json) = 'array' THEN JSON_ARRAY_LENGTH([[__data_mm_demo3_rel_many_cascade.files]]::json) ELSE 0 END) as [[multiMatchValue]] FROM "demo4" "__mm_demo4" LEFT JOIN "demo3" "__data_mm_demo3_rel_many_cascade" ON [[__data_mm_demo3_rel_many_cascade.id]] IN ({:p8}, {:p9}) WHERE "__mm_demo4"."id" = "demo4"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]]::numeric < {:TEST}::numeric)))) AND (CASE WHEN ([[__data_demo3_rel_one_cascade.files]] IS JSON OR JSON_VALID([[__data_demo3_rel_one_cascade.files]]::text)) AND json_typeof([[__data_demo3_rel_one_cascade.files]]::json) = 'array' THEN JSON_ARRAY_LENGTH([[__data_demo3_rel_one_cascade.files]]::json) ELSE 0 END)::numeric < {:TEST}::numeric AND (CASE WHEN ([[demo4_self_rel_one.self_rel_many]] IS JSON OR JSON_VALID([[demo4_self_rel_one.self_rel_many]]::text)) AND json_typeof([[demo4_self_rel_one.self_rel_many]]::json) = 'array' THEN JSON_ARRAY_LENGTH([[demo4_self_rel_one.self_rel_many]]::json) ELSE 0 END)::numeric = {:TEST}::numeric AND (CASE WHEN ([[demo4_self_rel_one.self_rel_many]] IS JSON OR JSON_VALID([[demo4_self_rel_one.self_rel_many]]::text)) AND json_typeof([[demo4_self_rel_one.self_rel_many]]::json) = 'array' THEN JSON_ARRAY_LENGTH([[demo4_self_rel_one.self_rel_many]]::json) ELSE 0 END)::numeric = {:TEST}::numeric AND (((CASE WHEN ([[demo4_self_rel_one_rel_many_cascade.files]] IS JSON OR JSON_VALID([[demo4_self_rel_one_rel_many_cascade.files]]::text)) AND json_typeof([[demo4_self_rel_one_rel_many_cascade.files]]::json) = 'array' THEN JSON_ARRAY_LENGTH([[demo4_self_rel_one_rel_many_cascade.files]]::json) ELSE 0 END)::numeric != {:TEST}::numeric) AND (NOT EXISTS (SELECT 1 FROM (SELECT (CASE WHEN ([[__mm_demo4_self_rel_one_rel_many_cascade.files]] IS JSON OR JSON_VALID([[__mm_demo4_self_rel_one_rel_many_cascade.files]]::text)) AND json_typeof([[__mm_demo4_self_rel_one_rel_many_cascade.files]]::json) = 'array' THEN JSON_ARRAY_LENGTH([[__mm_demo4_self_rel_one_rel_many_cascade.files]]::json) ELSE 0 END) as [[multiMatchValue]] FROM "demo4" "__mm_demo4" LEFT JOIN "demo4" "__mm_demo4_self_rel_one" ON [[__mm_demo4_self_rel_one.id]] = [[__mm_demo4.self_rel_one]] LEFT JOIN json_array_elements_text(CASE WHEN [[__mm_demo4_self_rel_one.rel_many_cascade]] IS JSON OR json_valid([[__mm_demo4_self_rel_one.rel_many_cascade]]::text) THEN [[__mm_demo4_self_rel_one.rel_many_cascade]]::json ELSE json_array([[__mm_demo4_self_rel_one.rel_many_cascade]]) END) "__mm_demo4_self_rel_one_rel_many_cascade_je" LEFT JOIN "demo3" "__mm_demo4_self_rel_one_rel_many_cascade" ON [[__mm_demo4_self_rel_one_rel_many_cascade.id]] = [[__mm_demo4_self_rel_one_rel_many_cascade_je.value]] WHERE "__mm_demo4"."id" = "demo4"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]]::numeric != {:TEST}::numeric)))) AND (CASE WHEN ([[demo4_self_rel_one_rel_many_cascade.files]] IS JSON OR JSON_VALID([[demo4_self_rel_one_rel_many_cascade.files]]::text)) AND json_typeof([[demo4_self_rel_one_rel_many_cascade.files]]::json) = 'array' THEN JSON_ARRAY_LENGTH([[demo4_self_rel_one_rel_many_cascade.files]]::json) ELSE 0 END)::numeric != {:TEST}::numeric)`,
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT "demo4".* FROM "demo4" WHERE (((CASE WHEN [[demo4.json_object]] IS JSON OR json_valid([[demo4.json_object]]::text) THEN JSON_QUERY([[demo4.json_object]]::json, '$.a.b') ELSE NULL END) #>> '{}')::text = ''::text AND (CASE WHEN ([[demo4.self_rel_many]] IS JSON OR JSON_VALID([[demo4.self_rel_many]]::text)) AND json_typeof([[demo4.self_rel_many]]::json) = 'array' THEN JSON_ARRAY_LENGTH([[demo4.self_rel_many]]::json) ELSE 0 END)::numeric != {:TEST}::numeric AND ((CASE WHEN [[demo4.json_object]] IS JSON OR json_valid([[demo4.json_object]]::text) THEN JSON_QUERY([[demo4.json_object]]::json, '$.a.b') ELSE NULL END) #>> '{}')::text::numeric > {:TEST}::numeric AND (CASE WHEN ([[demo4.self_rel_many]] IS JSON OR JSON_VALID([[demo4.self_rel_many]]::text)) AND json_typeof([[demo4.self_rel_many]]::json) = 'array' THEN JSON_ARRAY_LENGTH([[demo4.self_rel_many]]::json) ELSE 0 END)::numeric <= {:TEST}::numeric)`,
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT DISTINCT "demo4".* FROM "demo4" LEFT JOIN json_array_elements_text(CASE WHEN [[demo4.self_rel_many]] IS JSON OR json_valid([[demo4.self_rel_many]]::text) THEN [[demo4.self_rel_many]]::json ELSE json_array([[demo4.self_rel_many]]) END) "demo4_self_rel_many_je" LEFT JOIN "demo4" "demo4_self_rel_many" ON [[demo4_self_rel_many.id]] = [[demo4_self_rel_many_je.value]] WHERE (((CASE WHEN [[demo4.json_object]] IS JSON OR json_valid([[demo4.json_object]]::text) THEN JSON_QUERY([[demo4.json_object]]::json, '$') ELSE NULL END) #>> '{}')::text = ''::text OR ((CASE WHEN [[demo4.json_object]] IS JSON OR json_valid([[demo4.json_object]]::text) THEN JSON_QUERY([[demo4.json_object]]::json, '$') ELSE NULL END) #>> '{}')::text != ''::text OR ''::text = ((CASE WHEN [[demo4.json_object]] IS JSON OR json_valid([[demo4.json_object]]::text) THEN JSON_QUERY([[demo4.json_object]]::json, '$') ELSE NULL END) #>> '{}')::text OR ''::text != ((CASE WHEN [[demo4.json_object]] IS JSON OR json_valid([[demo4.json_object]]::text) THEN JSON_QUERY([[demo4.json_object]]::json, '$') ELSE NULL END) #>> '{}')::text OR ((CASE WHEN [[demo4.json_object]] IS JSON OR json_valid([[demo4.json_object]]::text) THEN JSON_QUERY([[demo4.json_object]]::json, '$') ELSE NULL END) #>> '{}')::text = ''::text OR ((CASE WHEN [[demo4.json_object]] IS JSON OR json_valid([[demo4.json_object]]::text) THEN JSON_QUERY([[demo4.json_object]]::json, '$') ELSE NULL END) #>> '{}')::text != ''::text OR ''::text = ((CASE WHEN [[demo4.json_object]] IS JSON OR json_valid([[demo4.json_object]]::text) THEN JSON_QUERY([[demo4.json_object]]::json, '$') ELSE NULL END) #>> '{}')::text OR ''::text != ((CASE WHEN [[demo4.json_object]] IS JSON OR json_valid([[demo4.json_object]]::text) THEN JSON_QUERY([[demo4.json_object]]::json, '$') ELSE NULL END) #>> '{}')::text OR ((CASE WHEN [[demo4.json_object]] IS JSON OR json_valid([[demo4.json_object]]::text) THEN JSON_QUERY([[demo4.json_object]]::json, '$') ELSE NULL END) #>> '{}')::text = TRUE::text OR ((CASE WHEN [[demo4.json_object]] IS JSON OR json_valid([[demo4.json_object]]::text) THEN JSON_QUERY([[demo4.json_object]]::json, '$') ELSE NULL END) #>> '{}')::text != TRUE::text OR TRUE::text = ((CASE WHEN [[demo4.json_object]] IS JSON OR json_valid([[demo4.json_object]]::text) THEN JSON_QUERY([[demo4.json_object]]::json, '$') ELSE NULL END) #>> '{}')::text OR TRUE::text != ((CASE WHEN [[demo4.json_object]] IS JSON OR json_valid([[demo4.json_object]]::text) THEN JSON_QUERY([[demo4.json_object]]::json, '$') ELSE NULL END) #>> '{}')::text OR ((CASE WHEN [[demo4.json_object]] IS JSON OR json_valid([[demo4.json_object]]::text) THEN JSON_QUERY([[demo4.json_object]]::json, '$') ELSE NULL END) #>> '{}')::text = ((CASE WHEN [[demo4.json_object]] IS JSON OR json_valid([[demo4.json_object]]::text) THEN JSON_QUERY([[demo4.json_object]]::json, '$') ELSE NULL END) #>> '{}')::text OR ((CASE WHEN [[demo4.json_object]] IS JSON OR json_valid([[demo4.json_object]]::text) THEN JSON_QUERY([[demo4.json_object]]::json, '$') ELSE NULL END) #>> '{}')::text != ((CASE WHEN [[demo4.json_object]] IS JSON OR json_valid([[demo4.json_object]]::text) THEN JSON_QUERY([[demo4.json_object]]::json, '$') ELSE NULL END) #>> '{}')::text OR ((CASE WHEN [[demo4.json_object]] IS JSON OR json_valid([[demo4.json_object]]::text) THEN JSON_QUERY([[demo4.json_object]]::json, '$') ELSE NULL END) #>> '{}')::text = [[demo4.title]]::text OR [[demo4.title]]::text != ((CASE WHEN [[demo4.json_object]] IS JSON OR json_valid([[demo4.json_object]]::text) THEN JSON_QUERY([[demo4.json_object]]::json, '$') ELSE NULL END) #>> '{}')::text OR ((((CASE WHEN [[demo4_self_rel_many.json_object]] IS JSON OR json_valid([[demo4_self_rel_many.json_object]]::text) THEN JSON_QUERY([[demo4_self_rel_many.json_object]]::json, '$') ELSE NULL END) #>> '{}')::text = ''::text) AND (NOT EXISTS (SELECT 1 FROM (SELECT ((CASE WHEN [[__mm_demo4_self_rel_many.json_object]] IS JSON OR json_valid([[__mm_demo4_self_rel_many.json_object]]::text) THEN JSON_QUERY([[__mm_demo4_self_rel_many.json_object]]::json, '$') ELSE NULL END) #>> '{}')::text as [[multiMatchValue]] FROM "demo4" "__mm_demo4" LEFT JOIN json_array_elements_text(CASE WHEN [[__mm_demo4.self_rel_many]] IS JSON OR json_valid([[__mm_demo4.self_rel_many]]::text) THEN [[__mm_demo4.self_rel_many]]::json ELSE json_array([[__mm_demo4.self_rel_many]]) END) "__mm_demo4_self_rel_many_je" LEFT JOIN "demo4" "__mm_demo4_self_rel_many" ON [[__mm_demo4_self_rel_many.id]] = [[__mm_demo4_self_rel_many_je.value]] WHERE "__mm_demo4"."id" = "demo4"."id") {{__smTEST}} WHERE NOT ([[__smTEST.multiMatchValue]] = '')))) OR ((''::text = ((CASE WHEN [[demo4_self_rel_many.json_object]] IS JSON OR json_valid([[demo4_self_rel_many.json_object]]::text) THEN JSON_QUERY([[demo4_self_rel_many.json_object]]::json, '$') ELSE NULL END) #>> '{}')::text) AND (NOT EXISTS (SELECT 1 FROM (SELECT ((CASE WHEN [[__mm_demo4_self_rel_many.json_object]] IS JSON OR json_valid([[__mm_demo4_self_rel_many.json_object]]::text) THEN JSON_QUERY([[__mm_demo4_self_rel_many.json_object]]::json, '$') ELSE NULL END) #>> '{}')::text as [[multiMatchValue]] FROM "demo4" "__mm_demo4" LEFT JOIN json_array_elements_text(CASE WHEN [[__mm_demo4.self_rel_many]] IS JSON OR json_valid([[__mm_demo4.self_rel_many]]::text) THEN [[__mm_demo4.self_rel_many]]::json ELSE json_array([[__mm_demo4.self_rel_many]]) END) "__mm_demo4_self_rel_many_je" LEFT JOIN "demo4" "__mm_demo4_self_rel_many" ON [[__mm_demo4_self_rel_many.id]] = [[__mm_demo4_self_rel_many_je.value]] WHERE "__mm_demo4"."id" = "demo4"."id") {{__smTEST}} WHERE NOT ('' = [[__smTEST.multiMatchValue]])))) OR ((((CASE WHEN [[demo4_self_rel_many.json_object]] IS JSON OR json_valid([[demo4_self_rel_many.json_object]]::text) THEN JSON_QUERY([[demo4_self_rel_many.json_object]]::json, '$') ELSE NULL END) #>> '{}')::text = ((CASE WHEN [[demo4_self_rel_many.json_object]] IS JSON OR json_valid([[demo4_self_rel_many.json_object]]::text) THEN JSON_QUERY([[demo4_self_rel_many.json_object]]::json, '$') ELSE NULL END) #>> '{}')::text) AND (NOT EXISTS (SELECT 1 FROM (SELECT ((CASE WHEN [[__mm_demo4_self_rel_many.json_object]] IS JSON OR json_valid([[__mm_demo4_self_rel_many.json_object]]::text) THEN JSON_QUERY([[__mm_demo4_self_rel_many.json_object]]::json, '$') ELSE NULL END) #>> '{}')::text as [[multiMatchValue]] FROM "demo4" "__mm_demo4" LEFT JOIN json_array_elements_text(CASE WHEN [[__mm_demo4.self_rel_many]] IS JSON OR json_valid([[__mm_demo4.self_rel_many]]::text) THEN [[__mm_demo4.self_rel_many]]::json ELSE json_array([[__mm_demo4.self_rel_many]]) END) "__mm_demo4_self_rel_many_je" LEFT JOIN "demo4" "__mm_demo4_self_rel_many" ON [[__mm_demo4_self_rel_many.id]] = [[__mm_demo4_self_rel_many_je.value]] WHERE "__mm_demo4"."id" = "demo4"."id") {{__mlTEST}} LEFT JOIN (SELECT ((CASE WHEN [[__mm_demo4_self_rel_many.json_object]] IS JSON OR json_valid([[__mm_demo4_self_rel_many.json_object]]::text) THEN JSON_QUERY([[__mm_demo4_self_rel_many.json_object]]::json, '$') ELSE NULL END) #>> '{}')::text as [[multiMatchValue]] FROM "demo4" "__mm_demo4" LEFT JOIN json_array_elements_text(CASE WHEN [[__mm_demo4.self_rel_many]] IS JSON OR json_valid([[__mm_demo4.self_rel_many]]::text) THEN [[__mm_demo4.self_rel_many]]::json ELSE json_array([[__mm_demo4.self_rel_many]]) END) "__mm_demo4_self_rel_many_je" LEFT JOIN "demo4" "__mm_demo4_self_rel_many" ON [[__mm_demo4_self_rel_many.id]] = [[__mm_demo4_self_rel_many_je.value]] WHERE "__mm_demo4"."id" = "demo4"."id") {{__mrTEST}} WHERE NOT ([[__mlTEST.multiMatchValue]] = [[__mrTEST.multiMatchValue]])))))`,
		},
		{
			...
			*/
			// PostgreSQL:
			`SELECT "demo1".* FROM "demo1" WHERE (([[demo1.point]] IS NOT DISTINCT FROM '' OR [[demo1.point]] IS NULL) OR ((CASE WHEN [[demo1.point]] IS JSON OR json_valid([[demo1.point]]::text) THEN JSON_QUERY([[demo1.point]]::json, '$.lat') ELSE NULL END) #>> '{}')::text::numeric > {:TEST}::numeric OR ((CASE WHEN [[demo1.point]] IS JSON OR json_valid([[demo1.point]]::text) THEN JSON_QUERY([[demo1.point]]::json, '$.lon') ELSE NULL END) #>> '{}')::text::numeric < {:TEST}::numeric OR ((CASE WHEN [[demo1.point]] IS JSON OR json_valid([[demo1.point]]::text) THEN JSON_QUERY([[demo1.point]]::json, '$.something') ELSE NULL END) #>> '{}')::text::numeric > {:TEST}::numeric)`,
		},
	}
...
func TestRecordFieldResolverResolveCollectionFields(t *testing.T) {
	...
	scenarios := []struct {
		...
		*/
		// PostgreSQL:
		{"json_array.0", false, "((CASE WHEN [[demo4.json_array]] IS JSON OR json_valid([[demo4.json_array]]::text) THEN JSON_QUERY([[demo4.json_array]]::json, '$[0]') ELSE NULL END) #>> '{}')::text"},
		{"json_object.a.b.c", false, "((CASE WHEN [[demo4.json_object]] IS JSON OR json_valid([[demo4.json_object]]::text) THEN JSON_QUERY([[demo4.json_object]]::json, '$.a.b.c') ELSE NULL END) #>> '{}')::text"},
		// max relations limit shouldn't apply for json paths
		{"json_object.a.b.c.e.f.g.h.i.j.k.l.m.n.o.p", false, "((CASE WHEN [[demo4.json_object]] IS JSON OR json_valid([[demo4.json_object]]::text) THEN JSON_QUERY([[demo4.json_object]]::json, '$.a.b.c.e.f.g.h.i.j.k.l.m.n.o.p') ELSE NULL END) #>> '{}')::text"},
