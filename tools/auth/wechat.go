...
func init() {
	Providers[NameWechatMobile] = func() Provider {
		return NewWechatProvider(wechatAuthTypeMobile)
	}
	Providers[NameWechatWeb] = func() Provider {
		return NewWechatProvider(wechatAuthTypeWeb)
	}
}
...
const (
	wechatAuthTypeMobile wechatAuthType = "mobile"
	wechatAuthTypeWeb    wechatAuthType = "web"
)
...
func NewWechatProvider(authType wechatAuthType) *Wechat {
	var scopes []string
	if authType == wechatAuthTypeMobile {
